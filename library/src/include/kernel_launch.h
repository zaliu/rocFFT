...
{\
    ...
    printf("number of thread blocks=%d, dim=%d, stride[0]=%d, stride[1]=%d\n", (int)data->gridParam.b_x, (int)data->node->dimension, (int)data->node->inStride[0],(int)data->node->inStride[1]); \
