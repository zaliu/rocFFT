...
template <typename T>
__device__ T
TW3step(const T *twiddles, size_t u)
{
	size_t j = u & 255;
	T result = twiddles[j];
	u >>= 8;
...
template <typename T>
__device__ void
FwdRad5B1(T *R0, T *R1, T *R2, T *R3, T *R4)
{
...
template <typename T>
__device__ void
InvRad5B1(T *R0, T *R1, T *R2, T *R3, T *R4)
{
...
template <typename T>
__device__ void
FwdRad6B1(T *R0, T *R1, T *R2, T *R3, T *R4, T *R5)
{
...
template <typename T>
__device__ void
InvRad6B1(T *R0, T *R1, T *R2, T *R3, T *R4, T *R5)
{
...
template <typename T>
__device__ void
FwdRad7B1(T *R0, T *R1, T *R2, T *R3, T *R4, T *R5, T *R6)
{
...
template <typename T>
__device__ void
InvRad7B1(T *R0, T *R1, T *R2, T *R3, T *R4, T *R5, T *R6)
{
...
template <typename T>
__device__ void
FwdRad8B1(T *R0, T *R4, T *R2, T *R6, T *R1, T *R5, T *R3, T *R7)
{
...
template <typename T>
__device__ void
InvRad8B1(T *R0, T *R4, T *R2, T *R6, T *R1, T *R5, T *R3, T *R7)
{
...
template <typename T>
__device__ void
FwdRad10B1(T *R0, T *R1, T *R2, T *R3, T *R4, T *R5, T *R6, T *R7, T *R8, T *R9)
{

	real_type_t<T> TR0, TI0, TR1, TI1, TR2, TI2, TR3, TI3, TR4, TI4, TR5, TI5, TR6, TI6, TR7, TI7, TR8, TI8, TR9, TI9;
...
template <typename T>
__device__ void
InvRad10B1(T *R0, T *R1, T *R2, T *R3, T *R4, T *R5, T *R6, T *R7, T *R8, T *R9)
{
...
template <typename T>
__device__ void
FwdRad16B1(T *R0, T *R8, T *R4, T *R12, T *R2, T *R10, T *R6, T *R14, T *R1, T *R9, T *R5, T *R13, T *R3, T *R11, T *R7, T *R15)
{
...
template<typename T>
__device__ void
InvRad16B1(T *R0, T *R8, T *R4, T *R12, T *R2, T *R10, T *R6, T *R14, T *R1, T *R9, T *R5, T *R13, T *R3, T *R11, T *R7, T *R15)
{
