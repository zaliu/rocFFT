...
Since the library interface accepts only buffers of type 'rocfft_buffer', the library provides couple of functions to work with memory created directly with HIP runtime API.
