...
#define PRE_MULVAL float2 mulval_pre(void* in, uint offset, void* userdata)\n \
				{ \n \
...
#define PRE_MULVAL_LDS float2 mulval_pre(void* in, uint offset, void* userdata, __local void* localmem)\n \
				{ \n \
...
#define POST_MULVAL void mulval_post(void *output, uint outoffset, void *userdata, float2 fftoutput )\n \
				{ \n \
