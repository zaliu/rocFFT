...
{
    try { normal_1D_forward_in_place_complex_planar_to_complex_planar< float,  fftwf_complex >(); }
...
{
    try { normal_1D_backward_in_place_complex_planar_to_complex_planar< float,  fftwf_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}
...
{
    try { normal_1D_forward_in_place_complex_interleaved_to_complex_interleaved< double,  fftw_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}
...
{
    try { normal_1D_backward_in_place_complex_interleaved_to_complex_interleaved< double,  fftw_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}
...
void normal_1D_forward_out_of_place_complex_planar_to_complex_planar()
{
    ...
    rocfft_array_type in_array_type = rocfft_array_type_complex_planar;
    rocfft_array_type out_array_type = rocfft_array_type_complex_planar;
    rocfft_result_placement placeness = rocfft_placement_notinplace;
    rocfft_transform_type transform_type = rocfft_transform_type_complex_forward;
...
{
    try { normal_1D_forward_out_of_place_complex_planar_to_complex_planar< float,  fftwf_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}

TEST_F(accuracy_test_pow2_double, normal_1D_forward_out_of_place_complex_planar_to_complex_planar)
{
    try { normal_1D_forward_out_of_place_complex_planar_to_complex_planar< double,  fftw_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}
...
{
    try { normal_1D_backward_out_of_place_complex_planar_to_complex_planar< float,  fftwf_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}
...
{
    try { normal_1D_forward_out_of_place_complex_interleaved_to_complex_interleaved< float,  fftwf_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}

TEST_F(accuracy_test_pow2_double, normal_1D_forward_out_of_place_complex_interleaved_to_complex_interleaved)
{
    try { normal_1D_forward_out_of_place_complex_interleaved_to_complex_interleaved< double,  fftw_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}
...
{
    try { normal_1D_backward_out_of_place_complex_interleaved_to_complex_interleaved< float,  fftwf_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}

TEST_F(accuracy_test_pow2_double, normal_1D_backward_out_of_place_complex_interleaved_to_complex_interleaved)
{
    try { normal_1D_backward_out_of_place_complex_interleaved_to_complex_interleaved< double,  fftw_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}
...
{
    try { normal_1D_forward_out_of_place_complex_planar_to_complex_interleaved< float,  fftwf_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}

TEST_F(accuracy_test_pow2_double, normal_1D_forward_out_of_place_complex_planar_to_complex_interleaved)
{
    try { normal_1D_forward_out_of_place_complex_planar_to_complex_interleaved< double,  fftw_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}
...
{
    try { normal_1D_backward_out_of_place_complex_planar_to_complex_interleaved< float,  fftwf_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}

TEST_F(accuracy_test_pow2_double, normal_1D_backward_out_of_place_complex_planar_to_complex_interleaved)
{
    try { normal_1D_backward_out_of_place_complex_planar_to_complex_interleaved< double,  fftw_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}
...
{
    try { normal_1D_forward_out_of_place_complex_interleaved_to_complex_planar< float,  fftwf_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}

TEST_F(accuracy_test_pow2_double, normal_1D_forward_out_of_place_complex_interleaved_to_complex_planar)
{
    try { normal_1D_forward_out_of_place_complex_interleaved_to_complex_planar< double,  fftw_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}
...
{
    try { normal_1D_backward_out_of_place_complex_interleaved_to_complex_planar< float,  fftwf_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}
...
void normal_1D_in_place_real_to_hermitian_interleaved()
{
    ...
    size_t input_distance = 0;
    size_t output_distance = 0;
    rocfft_array_type array_type = rocfft_array_type_hermitian_interleaved;
    rocfft_result_placement placeness = rocfft_placement_inplace;

    data_pattern pattern = sawtooth;
    real_to_complex<T, fftw_T>( pattern, lengths, batch, input_strides, output_strides, input_distance, output_distance, layout, placeness );
}

TEST_F(accuracy_test_pow2_single, normal_1D_in_place_real_to_hermitian_interleaved)
{
    try { normal_1D_in_place_real_to_hermitian_interleaved< float,  fftwf_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}

TEST_F(accuracy_test_pow2_double, normal_1D_in_place_real_to_hermitian_interleaved)
{
    try { normal_1D_in_place_real_to_hermitian_interleaved< double,  fftw_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}
...
void normal_1D_in_place_hermitian_interleaved_to_real()
{
    ...
    data_pattern pattern = sawtooth;
    complex_to_real<T, fftw_T>( pattern, lengths, batch, input_strides, output_strides, input_distance, output_distance, layout, placeness );
}

TEST_F(accuracy_test_pow2_single, normal_1D_in_place_hermitian_interleaved_to_real)
{
    try { normal_1D_in_place_hermitian_interleaved_to_real< float,  fftwf_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}

TEST_F(accuracy_test_pow2_double, normal_1D_in_place_hermitian_interleaved_to_real)
{
    try { normal_1D_in_place_hermitian_interleaved_to_real< double,  fftw_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}
...
{
    try { normal_1D_out_of_place_real_to_hermitian_interleaved< float,  fftwf_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}

TEST_F(accuracy_test_pow2_double, normal_1D_out_of_place_real_to_hermitian_interleaved)
{
    try { normal_1D_out_of_place_real_to_hermitian_interleaved< double,  fftw_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}
...
{
    try { normal_1D_out_of_place_hermitian_interleaved_to_real< float,  fftwf_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}

TEST_F(accuracy_test_pow2_double, normal_1D_out_of_place_hermitian_interleaved_to_real)
{
    try { normal_1D_out_of_place_hermitian_interleaved_to_real< double,  fftw_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}
...
void normal_1D_out_of_place_real_to_hermitian_planar()
{
    ...
    size_t input_distance = 0;
    size_t output_distance = 0;
    rocfft_array_type array_type = rocfft_array_type_hermitian_planar;
    rocfft_result_placement placeness = rocfft_placement_notinplace;
...
{
    try { normal_1D_out_of_place_real_to_hermitian_planar< float,  fftwf_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}

TEST_F(accuracy_test_pow2_double, normal_1D_out_of_place_real_to_hermitian_planar)
{
    try { normal_1D_out_of_place_real_to_hermitian_planar< double,  fftw_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}
...
{
    try { normal_1D_out_of_place_hermitian_planar_to_real< float,  fftwf_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}

TEST_F(accuracy_test_pow2_double, normal_1D_out_of_place_hermitian_planar_to_real)
{
    try { normal_1D_out_of_place_hermitian_planar_to_real< double,  fftw_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}
...
{
    try { small_1D_forward_in_place_complex_planar_to_complex_planar< float,  fftwf_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}

TEST_F(accuracy_test_pow2_double, small_1D_forward_in_place_complex_planar_to_complex_planar)
{
    try { small_1D_forward_in_place_complex_planar_to_complex_planar< double,  fftw_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}
...
{
    try { small_1D_backward_in_place_complex_planar_to_complex_planar< float,  fftwf_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}
...
{
    try { small_1D_forward_in_place_complex_interleaved_to_complex_interleaved< double,  fftw_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}
...
{
    try { small_1D_backward_in_place_complex_interleaved_to_complex_interleaved< double,  fftw_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}
...
{
    try { small_1D_forward_out_of_place_complex_planar_to_complex_planar< float,  fftwf_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}

TEST_F(accuracy_test_pow2_double, small_1D_forward_out_of_place_complex_planar_to_complex_planar)
{
    try { small_1D_forward_out_of_place_complex_planar_to_complex_planar< double,  fftw_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}
...
{
    try { small_1D_backward_out_of_place_complex_planar_to_complex_planar< float,  fftwf_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}
...
{
    try { small_1D_forward_out_of_place_complex_interleaved_to_complex_interleaved< float,  fftwf_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}

TEST_F(accuracy_test_pow2_double, small_1D_forward_out_of_place_complex_interleaved_to_complex_interleaved)
{
    try { small_1D_forward_out_of_place_complex_interleaved_to_complex_interleaved< double,  fftw_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}
...
{
    try { small_1D_backward_out_of_place_complex_interleaved_to_complex_interleaved< float,  fftwf_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}

TEST_F(accuracy_test_pow2_double, small_1D_backward_out_of_place_complex_interleaved_to_complex_interleaved)
{
    try { small_1D_backward_out_of_place_complex_interleaved_to_complex_interleaved< double,  fftw_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}
...
{
    try { small_1D_forward_out_of_place_complex_planar_to_complex_interleaved< float,  fftwf_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}

TEST_F(accuracy_test_pow2_double, small_1D_forward_out_of_place_complex_planar_to_complex_interleaved)
{
    try { small_1D_forward_out_of_place_complex_planar_to_complex_interleaved< double,  fftw_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}
...
{
    try { small_1D_backward_out_of_place_complex_planar_to_complex_interleaved< float,  fftwf_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}

TEST_F(accuracy_test_pow2_double, small_1D_backward_out_of_place_complex_planar_to_complex_interleaved)
{
    try { small_1D_backward_out_of_place_complex_planar_to_complex_interleaved< double,  fftw_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}
...
{
    try { small_1D_forward_out_of_place_complex_interleaved_to_complex_planar< float,  fftwf_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}

TEST_F(accuracy_test_pow2_double, small_1D_forward_out_of_place_complex_interleaved_to_complex_planar)
{
    try { small_1D_forward_out_of_place_complex_interleaved_to_complex_planar< double,  fftw_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}
...
{
    try { small_1D_backward_out_of_place_complex_interleaved_to_complex_planar< float,  fftwf_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}

TEST_F(accuracy_test_pow2_double, small_1D_backward_out_of_place_complex_interleaved_to_complex_planar)
{
    try { small_1D_backward_out_of_place_complex_interleaved_to_complex_planar< double,  fftw_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}
...
{
    try { small_1D_in_place_real_to_hermitian_interleaved< float,  fftwf_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}

TEST_F(accuracy_test_pow2_double, small_1D_in_place_real_to_hermitian_interleaved)
{
    try { small_1D_in_place_real_to_hermitian_interleaved< double,  fftw_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}
...
{
    try { small_1D_in_place_hermitian_interleaved_to_real< float,  fftwf_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}

TEST_F(accuracy_test_pow2_double, small_1D_in_place_hermitian_interleaved_to_real)
{
    try { small_1D_in_place_hermitian_interleaved_to_real< double,  fftw_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}
...
{
    try { small_1D_out_of_place_real_to_hermitian_interleaved< float,  fftwf_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}

TEST_F(accuracy_test_pow2_double, small_1D_out_of_place_real_to_hermitian_interleaved)
{
    try { small_1D_out_of_place_real_to_hermitian_interleaved< double,  fftw_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}
...
{
    try { small_1D_out_of_place_hermitian_interleaved_to_real< float,  fftwf_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}

TEST_F(accuracy_test_pow2_double, small_1D_out_of_place_hermitian_interleaved_to_real)
{
    try { small_1D_out_of_place_hermitian_interleaved_to_real< double,  fftw_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}
...
{
    try { small_1D_out_of_place_real_to_hermitian_planar< float,  fftwf_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}

TEST_F(accuracy_test_pow2_double, small_1D_out_of_place_real_to_hermitian_planar)
{
    try { small_1D_out_of_place_real_to_hermitian_planar< double,  fftw_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}
...
{
    try { small_1D_out_of_place_hermitian_planar_to_real< float,  fftwf_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}

TEST_F(accuracy_test_pow2_double, small_1D_out_of_place_hermitian_planar_to_real)
{
    try { small_1D_out_of_place_hermitian_planar_to_real< double,  fftw_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}
...
{
    try { large_1D_forward_in_place_complex_planar_to_complex_planar< float,  fftwf_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}

TEST_F(accuracy_test_pow2_double, large_1D_forward_in_place_complex_planar_to_complex_planar)
{
    try { large_1D_forward_in_place_complex_planar_to_complex_planar< double,  fftw_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}
...
{
    try { large_1D_backward_in_place_complex_planar_to_complex_planar< float,  fftwf_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}

TEST_F(accuracy_test_pow2_double, large_1D_backward_in_place_complex_planar_to_complex_planar)
{
    try { large_1D_backward_in_place_complex_planar_to_complex_planar< double,  fftw_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}
...
{
    try { large_1D_forward_in_place_complex_interleaved_to_complex_interleaved< double,  fftw_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}
...
{
    try { large_1D_backward_in_place_complex_interleaved_to_complex_interleaved< double,  fftw_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}
...
{
    try { large_1D_forward_out_of_place_complex_planar_to_complex_planar< float,  fftwf_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}

TEST_F(accuracy_test_pow2_double, large_1D_forward_out_of_place_complex_planar_to_complex_planar)
{
    try { large_1D_forward_out_of_place_complex_planar_to_complex_planar< double,  fftw_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}
...
{
    try { large_1D_backward_out_of_place_complex_planar_to_complex_planar< float,  fftwf_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}

TEST_F(accuracy_test_pow2_double, large_1D_backward_out_of_place_complex_planar_to_complex_planar)
{
    try { large_1D_backward_out_of_place_complex_planar_to_complex_planar< double,  fftw_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}
...
{
    try { large_1D_forward_out_of_place_complex_interleaved_to_complex_interleaved< float,  fftwf_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}

TEST_F(accuracy_test_pow2_double, large_1D_forward_out_of_place_complex_interleaved_to_complex_interleaved)
{
    try { large_1D_forward_out_of_place_complex_interleaved_to_complex_interleaved< double,  fftw_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}
...
{
    try { large_1D_backward_out_of_place_complex_interleaved_to_complex_interleaved< float,  fftwf_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}

TEST_F(accuracy_test_pow2_double, large_1D_backward_out_of_place_complex_interleaved_to_complex_interleaved)
{
    try { large_1D_backward_out_of_place_complex_interleaved_to_complex_interleaved< double,  fftw_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}
...
{
    try { large_1D_forward_out_of_place_complex_planar_to_complex_interleaved< float,  fftwf_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}

TEST_F(accuracy_test_pow2_double, large_1D_forward_out_of_place_complex_planar_to_complex_interleaved)
{
    try { large_1D_forward_out_of_place_complex_planar_to_complex_interleaved< double,  fftw_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}
...
{
    try { large_1D_backward_out_of_place_complex_planar_to_complex_interleaved< float,  fftwf_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}

TEST_F(accuracy_test_pow2_double, large_1D_backward_out_of_place_complex_planar_to_complex_interleaved)
{
    try { large_1D_backward_out_of_place_complex_planar_to_complex_interleaved< double,  fftw_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}
...
{
    try { large_1D_forward_out_of_place_complex_interleaved_to_complex_planar< float,  fftwf_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}

TEST_F(accuracy_test_pow2_double, large_1D_forward_out_of_place_complex_interleaved_to_complex_planar)
{
    try { large_1D_forward_out_of_place_complex_interleaved_to_complex_planar< double,  fftw_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}
...
{
    try { large_1D_backward_out_of_place_complex_interleaved_to_complex_planar< float,  fftwf_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}

TEST_F(accuracy_test_pow2_double, large_1D_backward_out_of_place_complex_interleaved_to_complex_planar)
{
    try { large_1D_backward_out_of_place_complex_interleaved_to_complex_planar< double,  fftw_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}
...
{
    try { large_1D_in_place_real_to_hermitian_interleaved< float,  fftwf_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}

TEST_F(accuracy_test_pow2_double, large_1D_in_place_real_to_hermitian_interleaved)
{
    try { large_1D_in_place_real_to_hermitian_interleaved< double,  fftw_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}
...
{
    try { large_1D_4M_in_place_real_to_hermitian_interleaved< float,  fftwf_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}

TEST_F(accuracy_test_pow2_double, large_1D_4M_in_place_real_to_hermitian_interleaved)
{
    try { large_1D_4M_in_place_real_to_hermitian_interleaved< double,  fftw_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}
// *****************************************************
// *****************************************************
...
{
    try { large_1D_in_place_hermitian_interleaved_to_real< float,  fftwf_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}

TEST_F(accuracy_test_pow2_double, large_1D_in_place_hermitian_interleaved_to_real)
{
    try { large_1D_in_place_hermitian_interleaved_to_real< double,  fftw_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}
...
{
    try { large_1D_out_of_place_real_to_hermitian_interleaved< float,  fftwf_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}

TEST_F(accuracy_test_pow2_double, large_1D_out_of_place_real_to_hermitian_interleaved)
{
    try { large_1D_out_of_place_real_to_hermitian_interleaved< double,  fftw_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}
...
{
    try { large_1D_out_of_place_hermitian_interleaved_to_real< float,  fftwf_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}

TEST_F(accuracy_test_pow2_double, large_1D_out_of_place_hermitian_interleaved_to_real)
{
    try { large_1D_out_of_place_hermitian_interleaved_to_real< double,  fftw_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}
...
{
    try { large_1D_out_of_place_real_to_hermitian_planar< float,  fftwf_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}

TEST_F(accuracy_test_pow2_double, large_1D_out_of_place_real_to_hermitian_planar)
{
    try { large_1D_out_of_place_real_to_hermitian_planar< double,  fftw_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}
...
{
    try { large_1D_out_of_place_hermitian_planar_to_real< float,  fftwf_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}

TEST_F(accuracy_test_pow2_double, large_1D_out_of_place_hermitian_planar_to_real)
{
    try { large_1D_out_of_place_hermitian_planar_to_real< double,  fftw_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}
...
{
    try { normal_2D_forward_in_place_complex_planar_to_complex_planar< float,  fftwf_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}

TEST_F(accuracy_test_pow2_double, normal_2D_forward_in_place_complex_planar_to_complex_planar)
{
    try { normal_2D_forward_in_place_complex_planar_to_complex_planar< double,  fftw_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}
...
{
    try { normal_2D_backward_in_place_complex_planar_to_complex_planar< float,  fftwf_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}

TEST_F(accuracy_test_pow2_double, normal_2D_backward_in_place_complex_planar_to_complex_planar)
{
    try { normal_2D_backward_in_place_complex_planar_to_complex_planar< double,  fftw_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}
...
{
    try { normal_2D_forward_in_place_complex_interleaved_to_complex_interleaved< float,  fftwf_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}

TEST_F(accuracy_test_pow2_double, normal_2D_forward_in_place_complex_interleaved_to_complex_interleaved)
{
    try { normal_2D_forward_in_place_complex_interleaved_to_complex_interleaved< double,  fftw_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}
...
{
    try { normal_2D_backward_in_place_complex_interleaved_to_complex_interleaved< float,  fftwf_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}

TEST_F(accuracy_test_pow2_double, normal_2D_backward_in_place_complex_interleaved_to_complex_interleaved)
{
    try { normal_2D_backward_in_place_complex_interleaved_to_complex_interleaved< double,  fftw_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}
...
{
    try { normal_2D_forward_out_of_place_complex_planar_to_complex_planar< float,  fftwf_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}

TEST_F(accuracy_test_pow2_double, normal_2D_forward_out_of_place_complex_planar_to_complex_planar)
{
    try { normal_2D_forward_out_of_place_complex_planar_to_complex_planar< double,  fftw_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}
...
{
    try { normal_2D_backward_out_of_place_complex_planar_to_complex_planar< float,  fftwf_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}

TEST_F(accuracy_test_pow2_double, normal_2D_backward_out_of_place_complex_planar_to_complex_planar)
{
    try { normal_2D_backward_out_of_place_complex_planar_to_complex_planar< double,  fftw_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}
...
{
    try { normal_2D_forward_out_of_place_complex_interleaved_to_complex_interleaved< float,  fftwf_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}

TEST_F(accuracy_test_pow2_double, normal_2D_forward_out_of_place_complex_interleaved_to_complex_interleaved)
{
    try { normal_2D_forward_out_of_place_complex_interleaved_to_complex_interleaved< double,  fftw_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}
...
{
    try { normal_2D_backward_out_of_place_complex_interleaved_to_complex_interleaved< float,  fftwf_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}

TEST_F(accuracy_test_pow2_double, normal_2D_backward_out_of_place_complex_interleaved_to_complex_interleaved)
{
    try { normal_2D_backward_out_of_place_complex_interleaved_to_complex_interleaved< double,  fftw_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}
...
{
    try { normal_2D_forward_out_of_place_complex_planar_to_complex_interleaved< float,  fftwf_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}

TEST_F(accuracy_test_pow2_double, normal_2D_forward_out_of_place_complex_planar_to_complex_interleaved)
{
    try { normal_2D_forward_out_of_place_complex_planar_to_complex_interleaved< double,  fftw_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}
...
{
    try { normal_2D_backward_out_of_place_complex_planar_to_complex_interleaved< float,  fftwf_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}

TEST_F(accuracy_test_pow2_double, normal_2D_backward_out_of_place_complex_planar_to_complex_interleaved)
{
    try { normal_2D_backward_out_of_place_complex_planar_to_complex_interleaved< double,  fftw_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}
...
{
    try { normal_2D_forward_out_of_place_complex_interleaved_to_complex_planar< float,  fftwf_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}

TEST_F(accuracy_test_pow2_double, normal_2D_forward_out_of_place_complex_interleaved_to_complex_planar)
{
    try { normal_2D_forward_out_of_place_complex_interleaved_to_complex_planar< double,  fftw_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}
...
{
    try { normal_2D_backward_out_of_place_complex_interleaved_to_complex_planar< float,  fftwf_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}

TEST_F(accuracy_test_pow2_double, normal_2D_backward_out_of_place_complex_interleaved_to_complex_planar)
{
    try { normal_2D_backward_out_of_place_complex_interleaved_to_complex_planar< double,  fftw_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}
...
{
    try { normal_2D_in_place_real_to_hermitian_interleaved< float,  fftwf_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}

TEST_F(accuracy_test_pow2_double, normal_2D_in_place_real_to_hermitian_interleaved)
{
    try { normal_2D_in_place_real_to_hermitian_interleaved< double,  fftw_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}
...
{
    try { normal_2D_in_place_hermitian_interleaved_to_real< float,  fftwf_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}

TEST_F(accuracy_test_pow2_double, normal_2D_in_place_hermitian_interleaved_to_real)
{
    try { normal_2D_in_place_hermitian_interleaved_to_real< double,  fftw_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}
...
{
    try { normal_2D_out_of_place_real_to_hermitian_interleaved< float,  fftwf_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}

TEST_F(accuracy_test_pow2_double, normal_2D_out_of_place_real_to_hermitian_interleaved)
{
    try { normal_2D_out_of_place_real_to_hermitian_interleaved< double,  fftw_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}
...
{
    try { normal_2D_out_of_place_hermitian_interleaved_to_real< float,  fftwf_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}

TEST_F(accuracy_test_pow2_double, normal_2D_out_of_place_hermitian_interleaved_to_real)
{
    try { normal_2D_out_of_place_hermitian_interleaved_to_real< double,  fftw_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}
...
{
    try { normal_2D_out_of_place_real_to_hermitian_planar< float,  fftwf_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}

TEST_F(accuracy_test_pow2_double, normal_2D_out_of_place_real_to_hermitian_planar)
{
    try { normal_2D_out_of_place_real_to_hermitian_planar< double,  fftw_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}
...
{
    try { normal_2D_out_of_place_hermitian_planar_to_real< float,  fftwf_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}

TEST_F(accuracy_test_pow2_double, normal_2D_out_of_place_hermitian_planar_to_real)
{
    try { normal_2D_out_of_place_hermitian_planar_to_real< double,  fftw_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}
...
{
    try { small_2D_forward_in_place_complex_planar_to_complex_planar< float,  fftwf_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}

TEST_F(accuracy_test_pow2_double, small_2D_forward_in_place_complex_planar_to_complex_planar)
{
    try { small_2D_forward_in_place_complex_planar_to_complex_planar< double,  fftw_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}
...
{
    try { small_2D_backward_in_place_complex_planar_to_complex_planar< float,  fftwf_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}

TEST_F(accuracy_test_pow2_double, small_2D_backward_in_place_complex_planar_to_complex_planar)
{
    try { small_2D_backward_in_place_complex_planar_to_complex_planar< double,  fftw_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}
...
{
    try { small_2D_forward_in_place_complex_interleaved_to_complex_interleaved< float,  fftwf_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}

TEST_F(accuracy_test_pow2_double, small_2D_forward_in_place_complex_interleaved_to_complex_interleaved)
{
    try { small_2D_forward_in_place_complex_interleaved_to_complex_interleaved< double,  fftw_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}
...
{
    try { small_2D_backward_in_place_complex_interleaved_to_complex_interleaved< float,  fftwf_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}

TEST_F(accuracy_test_pow2_double, small_2D_backward_in_place_complex_interleaved_to_complex_interleaved)
{
    try { small_2D_backward_in_place_complex_interleaved_to_complex_interleaved< double,  fftw_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}
...
{
    try { small_2D_forward_out_of_place_complex_planar_to_complex_planar< float,  fftwf_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}

TEST_F(accuracy_test_pow2_double, small_2D_forward_out_of_place_complex_planar_to_complex_planar)
{
    try { small_2D_forward_out_of_place_complex_planar_to_complex_planar< double,  fftw_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}
...
{
    try { small_2D_backward_out_of_place_complex_planar_to_complex_planar< float,  fftwf_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}

TEST_F(accuracy_test_pow2_double, small_2D_backward_out_of_place_complex_planar_to_complex_planar)
{
    try { small_2D_backward_out_of_place_complex_planar_to_complex_planar< double,  fftw_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}
...
{
    try { small_2D_forward_out_of_place_complex_interleaved_to_complex_interleaved< float,  fftwf_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}

TEST_F(accuracy_test_pow2_double, small_2D_forward_out_of_place_complex_interleaved_to_complex_interleaved)
{
    try { small_2D_forward_out_of_place_complex_interleaved_to_complex_interleaved< double,  fftw_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}
...
{
    try { small_2D_backward_out_of_place_complex_interleaved_to_complex_interleaved< float,  fftwf_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}

TEST_F(accuracy_test_pow2_double, small_2D_backward_out_of_place_complex_interleaved_to_complex_interleaved)
{
    try { small_2D_backward_out_of_place_complex_interleaved_to_complex_interleaved< double,  fftw_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}
...
{
    try { small_2D_forward_out_of_place_complex_planar_to_complex_interleaved< float,  fftwf_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}

TEST_F(accuracy_test_pow2_double, small_2D_forward_out_of_place_complex_planar_to_complex_interleaved)
{
    try { small_2D_forward_out_of_place_complex_planar_to_complex_interleaved< double,  fftw_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}
...
{
    try { small_2D_backward_out_of_place_complex_planar_to_complex_interleaved< float,  fftwf_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}

TEST_F(accuracy_test_pow2_double, small_2D_backward_out_of_place_complex_planar_to_complex_interleaved)
{
    try { small_2D_backward_out_of_place_complex_planar_to_complex_interleaved< double,  fftw_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}
...
{
    try { small_2D_forward_out_of_place_complex_interleaved_to_complex_planar< float,  fftwf_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}

TEST_F(accuracy_test_pow2_double, small_2D_forward_out_of_place_complex_interleaved_to_complex_planar)
{
    try { small_2D_forward_out_of_place_complex_interleaved_to_complex_planar< double,  fftw_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}
...
{
    try { small_2D_backward_out_of_place_complex_interleaved_to_complex_planar< float,  fftwf_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}

TEST_F(accuracy_test_pow2_double, small_2D_backward_out_of_place_complex_interleaved_to_complex_planar)
{
    try { small_2D_backward_out_of_place_complex_interleaved_to_complex_planar< double,  fftw_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}
...
{
    try { small_2D_in_place_real_to_hermitian_interleaved< float,  fftwf_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}

TEST_F(accuracy_test_pow2_double, small_2D_in_place_real_to_hermitian_interleaved)
{
    try { small_2D_in_place_real_to_hermitian_interleaved< double,  fftw_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}
...
{
    try { small_2D_in_place_hermitian_interleaved_to_real< float,  fftwf_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}

TEST_F(accuracy_test_pow2_double, small_2D_in_place_hermitian_interleaved_to_real)
{
    try { small_2D_in_place_hermitian_interleaved_to_real< double,  fftw_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}
...
{
    try { small_2D_out_of_place_real_to_hermitian_interleaved< float,  fftwf_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}

TEST_F(accuracy_test_pow2_double, small_2D_out_of_place_real_to_hermitian_interleaved)
{
    try { small_2D_out_of_place_real_to_hermitian_interleaved< double,  fftw_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}
...
{
    try { small_2D_out_of_place_hermitian_interleaved_to_real< float,  fftwf_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}

TEST_F(accuracy_test_pow2_double, small_2D_out_of_place_hermitian_interleaved_to_real)
{
    try { small_2D_out_of_place_hermitian_interleaved_to_real< double,  fftw_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}
...
{
    try { small_2D_out_of_place_real_to_hermitian_planar< float,  fftwf_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}

TEST_F(accuracy_test_pow2_double, small_2D_out_of_place_real_to_hermitian_planar)
{
    try { small_2D_out_of_place_real_to_hermitian_planar< double,  fftw_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}
...
{
    try { small_2D_out_of_place_hermitian_planar_to_real< float,  fftwf_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}

TEST_F(accuracy_test_pow2_double, small_2D_out_of_place_hermitian_planar_to_real)
{
    try { small_2D_out_of_place_hermitian_planar_to_real< double,  fftw_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}
...
{
    try { large_2D_forward_in_place_complex_planar_to_complex_planar< float,  fftwf_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}

TEST_F(accuracy_test_pow2_double, large_2D_forward_in_place_complex_planar_to_complex_planar)
{
    try { large_2D_forward_in_place_complex_planar_to_complex_planar< double,  fftw_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}
...
{
    try { large_2D_backward_in_place_complex_planar_to_complex_planar< float,  fftwf_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}

TEST_F(accuracy_test_pow2_double, large_2D_backward_in_place_complex_planar_to_complex_planar)
{
    try { large_2D_backward_in_place_complex_planar_to_complex_planar< double,  fftw_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}
...
{
    try { large_2D_forward_in_place_complex_interleaved_to_complex_interleaved< float,  fftwf_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}

TEST_F(accuracy_test_pow2_double, large_2D_forward_in_place_complex_interleaved_to_complex_interleaved)
{
    try { large_2D_forward_in_place_complex_interleaved_to_complex_interleaved< double,  fftw_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}
...
{
    try { large_2D_backward_in_place_complex_interleaved_to_complex_interleaved< float,  fftwf_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}

TEST_F(accuracy_test_pow2_double, large_2D_backward_in_place_complex_interleaved_to_complex_interleaved)
{
    try { large_2D_backward_in_place_complex_interleaved_to_complex_interleaved< double,  fftw_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}
...
{
    try { large_2D_forward_out_of_place_complex_planar_to_complex_planar< float,  fftwf_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}

TEST_F(accuracy_test_pow2_double, large_2D_forward_out_of_place_complex_planar_to_complex_planar)
{
    try { large_2D_forward_out_of_place_complex_planar_to_complex_planar< double,  fftw_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}
...
{
    try { large_2D_backward_out_of_place_complex_planar_to_complex_planar< float,  fftwf_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}

TEST_F(accuracy_test_pow2_double, large_2D_backward_out_of_place_complex_planar_to_complex_planar)
{
    try { large_2D_backward_out_of_place_complex_planar_to_complex_planar< double,  fftw_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}
...
{
    try { large_2D_forward_out_of_place_complex_interleaved_to_complex_interleaved< float,  fftwf_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}

TEST_F(accuracy_test_pow2_double, large_2D_forward_out_of_place_complex_interleaved_to_complex_interleaved)
{
    try { large_2D_forward_out_of_place_complex_interleaved_to_complex_interleaved< double,  fftw_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}
...
{
    try { large_2D_backward_out_of_place_complex_interleaved_to_complex_interleaved< float,  fftwf_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}

TEST_F(accuracy_test_pow2_double, large_2D_backward_out_of_place_complex_interleaved_to_complex_interleaved)
{
    try { large_2D_backward_out_of_place_complex_interleaved_to_complex_interleaved< double,  fftw_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}
...
{
    try { large_2D_forward_out_of_place_complex_planar_to_complex_interleaved< float,  fftwf_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}

TEST_F(accuracy_test_pow2_double, large_2D_forward_out_of_place_complex_planar_to_complex_interleaved)
{
    try { large_2D_forward_out_of_place_complex_planar_to_complex_interleaved< double,  fftw_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}
...
{
    try { large_2D_backward_out_of_place_complex_planar_to_complex_interleaved< float,  fftwf_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}

TEST_F(accuracy_test_pow2_double, large_2D_backward_out_of_place_complex_planar_to_complex_interleaved)
{
    try { large_2D_backward_out_of_place_complex_planar_to_complex_interleaved< double,  fftw_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}
...
{
    try { large_2D_forward_out_of_place_complex_interleaved_to_complex_planar< float,  fftwf_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}

TEST_F(accuracy_test_pow2_double, large_2D_forward_out_of_place_complex_interleaved_to_complex_planar)
{
    try { large_2D_forward_out_of_place_complex_interleaved_to_complex_planar< double,  fftw_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}
...
{
    try { large_2D_backward_out_of_place_complex_interleaved_to_complex_planar< float,  fftwf_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}

TEST_F(accuracy_test_pow2_double, large_2D_backward_out_of_place_complex_interleaved_to_complex_planar)
{
    try { large_2D_backward_out_of_place_complex_interleaved_to_complex_planar< double,  fftw_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}
...
{
    try { large_2D_in_place_real_to_hermitian_interleaved< float,  fftwf_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}

TEST_F(accuracy_test_pow2_double, large_2D_in_place_real_to_hermitian_interleaved)
{
    try { large_2D_in_place_real_to_hermitian_interleaved< double,  fftw_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}
...
{
    try { large_2D_in_place_hermitian_interleaved_to_real< float,  fftwf_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}

TEST_F(accuracy_test_pow2_double, large_2D_in_place_hermitian_interleaved_to_real)
{
    try { large_2D_in_place_hermitian_interleaved_to_real< double,  fftw_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}
...
{
    try { large_2D_out_of_place_real_to_hermitian_interleaved< float,  fftwf_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}

TEST_F(accuracy_test_pow2_double, large_2D_out_of_place_real_to_hermitian_interleaved)
{
    try { large_2D_out_of_place_real_to_hermitian_interleaved< double,  fftw_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}
...
{
    try { large_2D_out_of_place_hermitian_interleaved_to_real< float,  fftwf_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}

TEST_F(accuracy_test_pow2_double, large_2D_out_of_place_hermitian_interleaved_to_real)
{
    try { large_2D_out_of_place_hermitian_interleaved_to_real< double,  fftw_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}
...
{
    try { large_2D_out_of_place_real_to_hermitian_planar< float,  fftwf_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}

TEST_F(accuracy_test_pow2_double, large_2D_out_of_place_real_to_hermitian_planar)
{
    try { large_2D_out_of_place_real_to_hermitian_planar< double,  fftw_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}
...
{
    try { large_2D_out_of_place_hermitian_planar_to_real< float,  fftwf_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}

TEST_F(accuracy_test_pow2_double, large_2D_out_of_place_hermitian_planar_to_real)
{
    try { large_2D_out_of_place_hermitian_planar_to_real< double,  fftw_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}
...
{
    try { normal_3D_forward_in_place_complex_planar_to_complex_planar< float,  fftwf_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}

TEST_F(accuracy_test_pow2_double, normal_3D_forward_in_place_complex_planar_to_complex_planar)
{
    try { normal_3D_forward_in_place_complex_planar_to_complex_planar< double,  fftw_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}
...
{
    try { normal_3D_backward_in_place_complex_planar_to_complex_planar< float,  fftwf_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}

TEST_F(accuracy_test_pow2_double, normal_3D_backward_in_place_complex_planar_to_complex_planar)
{
    try { normal_3D_backward_in_place_complex_planar_to_complex_planar< double,  fftw_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}
...
{
    try { normal_3D_forward_in_place_complex_interleaved_to_complex_interleaved< float,  fftwf_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}

TEST_F(accuracy_test_pow2_double, normal_3D_forward_in_place_complex_interleaved_to_complex_interleaved)
{
    try { normal_3D_forward_in_place_complex_interleaved_to_complex_interleaved< double,  fftw_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}
...
{
    try { normal_3D_backward_in_place_complex_interleaved_to_complex_interleaved< float,  fftwf_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}

TEST_F(accuracy_test_pow2_double, normal_3D_backward_in_place_complex_interleaved_to_complex_interleaved)
{
    try { normal_3D_backward_in_place_complex_interleaved_to_complex_interleaved< double,  fftw_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}
...
{
    try { normal_3D_forward_out_of_place_complex_planar_to_complex_planar< float,  fftwf_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}

TEST_F(accuracy_test_pow2_double, normal_3D_forward_out_of_place_complex_planar_to_complex_planar)
{
    try { normal_3D_forward_out_of_place_complex_planar_to_complex_planar< double,  fftw_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}
...
{
    try { normal_3D_backward_out_of_place_complex_planar_to_complex_planar< float,  fftwf_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}

TEST_F(accuracy_test_pow2_double, normal_3D_backward_out_of_place_complex_planar_to_complex_planar)
{
    try { normal_3D_backward_out_of_place_complex_planar_to_complex_planar< double,  fftw_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}
...
{
    try { normal_3D_forward_out_of_place_complex_interleaved_to_complex_interleaved< float,  fftwf_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}

TEST_F(accuracy_test_pow2_double, normal_3D_forward_out_of_place_complex_interleaved_to_complex_interleaved)
{
    try { normal_3D_forward_out_of_place_complex_interleaved_to_complex_interleaved< double,  fftw_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}
...
{
    try { normal_3D_backward_out_of_place_complex_interleaved_to_complex_interleaved< float,  fftwf_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}

TEST_F(accuracy_test_pow2_double, normal_3D_backward_out_of_place_complex_interleaved_to_complex_interleaved)
{
    try { normal_3D_backward_out_of_place_complex_interleaved_to_complex_interleaved< double,  fftw_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}
...
{
    try { normal_3D_forward_out_of_place_complex_planar_to_complex_interleaved< float,  fftwf_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}

TEST_F(accuracy_test_pow2_double, normal_3D_forward_out_of_place_complex_planar_to_complex_interleaved)
{
    try { normal_3D_forward_out_of_place_complex_planar_to_complex_interleaved< double,  fftw_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}
...
{
    try { normal_3D_backward_out_of_place_complex_planar_to_complex_interleaved< float,  fftwf_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}

TEST_F(accuracy_test_pow2_double, normal_3D_backward_out_of_place_complex_planar_to_complex_interleaved)
{
    try { normal_3D_backward_out_of_place_complex_planar_to_complex_interleaved< double,  fftw_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}
...
{
    try { normal_3D_forward_out_of_place_complex_interleaved_to_complex_planar< float,  fftwf_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}

TEST_F(accuracy_test_pow2_double, normal_3D_forward_out_of_place_complex_interleaved_to_complex_planar)
{
    try { normal_3D_forward_out_of_place_complex_interleaved_to_complex_planar< double,  fftw_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}
...
{
    try { normal_3D_backward_out_of_place_complex_interleaved_to_complex_planar< float,  fftwf_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}

TEST_F(accuracy_test_pow2_double, normal_3D_backward_out_of_place_complex_interleaved_to_complex_planar)
{
    try { normal_3D_backward_out_of_place_complex_interleaved_to_complex_planar< double,  fftw_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}
...
{
    try { normal_3D_in_place_real_to_hermitian_interleaved< float,  fftwf_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}

TEST_F(accuracy_test_pow2_double, normal_3D_in_place_real_to_hermitian_interleaved)
{
    try { normal_3D_in_place_real_to_hermitian_interleaved< double,  fftw_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}
...
{
    try { normal_3D_in_place_hermitian_interleaved_to_real< float,  fftwf_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}

TEST_F(accuracy_test_pow2_double, normal_3D_in_place_hermitian_interleaved_to_real)
{
    try { normal_3D_in_place_hermitian_interleaved_to_real< double,  fftw_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}
...
{
    try { normal_3D_out_of_place_real_to_hermitian_interleaved< float,  fftwf_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}

TEST_F(accuracy_test_pow2_double, normal_3D_out_of_place_real_to_hermitian_interleaved)
{
    try { normal_3D_out_of_place_real_to_hermitian_interleaved< double,  fftw_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}
...
{
    try { normal_3D_out_of_place_hermitian_interleaved_to_real< float,  fftwf_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}

TEST_F(accuracy_test_pow2_double, normal_3D_out_of_place_hermitian_interleaved_to_real)
{
    try { normal_3D_out_of_place_hermitian_interleaved_to_real< double,  fftw_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}
...
{
    try { normal_3D_out_of_place_real_to_hermitian_planar< float,  fftwf_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}

TEST_F(accuracy_test_pow2_double, normal_3D_out_of_place_real_to_hermitian_planar)
{
    try { normal_3D_out_of_place_real_to_hermitian_planar< double,  fftw_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}
...
{
    try { normal_3D_out_of_place_hermitian_planar_to_real< float,  fftwf_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}

TEST_F(accuracy_test_pow2_double, normal_3D_out_of_place_hermitian_planar_to_real)
{
    try { normal_3D_out_of_place_hermitian_planar_to_real< double,  fftw_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}
...
{
    try { small_3D_forward_in_place_complex_planar_to_complex_planar< float,  fftwf_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}

TEST_F(accuracy_test_pow2_double, small_3D_forward_in_place_complex_planar_to_complex_planar)
{
    try { small_3D_forward_in_place_complex_planar_to_complex_planar< double,  fftw_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}
...
{
    try { small_3D_backward_in_place_complex_planar_to_complex_planar< float,  fftwf_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}

TEST_F(accuracy_test_pow2_double, small_3D_backward_in_place_complex_planar_to_complex_planar)
{
    try { small_3D_backward_in_place_complex_planar_to_complex_planar< double,  fftw_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}
...
{
    try { small_3D_forward_in_place_complex_interleaved_to_complex_interleaved< float,  fftwf_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}

TEST_F(accuracy_test_pow2_double, small_3D_forward_in_place_complex_interleaved_to_complex_interleaved)
{
    try { small_3D_forward_in_place_complex_interleaved_to_complex_interleaved< double,  fftw_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}
...
{
    try { small_3D_backward_in_place_complex_interleaved_to_complex_interleaved< float,  fftwf_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}

TEST_F(accuracy_test_pow2_double, small_3D_backward_in_place_complex_interleaved_to_complex_interleaved)
{
    try { small_3D_backward_in_place_complex_interleaved_to_complex_interleaved< double,  fftw_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}
...
{
    try { small_3D_forward_out_of_place_complex_planar_to_complex_planar< float,  fftwf_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}

TEST_F(accuracy_test_pow2_double, small_3D_forward_out_of_place_complex_planar_to_complex_planar)
{
    try { small_3D_forward_out_of_place_complex_planar_to_complex_planar< double,  fftw_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}
...
{
    try { small_3D_backward_out_of_place_complex_planar_to_complex_planar< float,  fftwf_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}

TEST_F(accuracy_test_pow2_double, small_3D_backward_out_of_place_complex_planar_to_complex_planar)
{
    try { small_3D_backward_out_of_place_complex_planar_to_complex_planar< double,  fftw_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}
...
{
    try { small_3D_forward_out_of_place_complex_interleaved_to_complex_interleaved< float,  fftwf_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}

TEST_F(accuracy_test_pow2_double, small_3D_forward_out_of_place_complex_interleaved_to_complex_interleaved)
{
    try { small_3D_forward_out_of_place_complex_interleaved_to_complex_interleaved< double,  fftw_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}
...
{
    try { small_3D_backward_out_of_place_complex_interleaved_to_complex_interleaved< float,  fftwf_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}

TEST_F(accuracy_test_pow2_double, small_3D_backward_out_of_place_complex_interleaved_to_complex_interleaved)
{
    try { small_3D_backward_out_of_place_complex_interleaved_to_complex_interleaved< double,  fftw_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}
...
{
    try { small_3D_forward_out_of_place_complex_planar_to_complex_interleaved< float,  fftwf_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}

TEST_F(accuracy_test_pow2_double, small_3D_forward_out_of_place_complex_planar_to_complex_interleaved)
{
    try { small_3D_forward_out_of_place_complex_planar_to_complex_interleaved< double,  fftw_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}
...
{
    try { small_3D_backward_out_of_place_complex_planar_to_complex_interleaved< float,  fftwf_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}

TEST_F(accuracy_test_pow2_double, small_3D_backward_out_of_place_complex_planar_to_complex_interleaved)
{
    try { small_3D_backward_out_of_place_complex_planar_to_complex_interleaved< double,  fftw_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}
...
{
    try { small_3D_forward_out_of_place_complex_interleaved_to_complex_planar< float,  fftwf_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}

TEST_F(accuracy_test_pow2_double, small_3D_forward_out_of_place_complex_interleaved_to_complex_planar)
{
    try { small_3D_forward_out_of_place_complex_interleaved_to_complex_planar< double,  fftw_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}
...
{
    try { small_3D_backward_out_of_place_complex_interleaved_to_complex_planar< float,  fftwf_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}

TEST_F(accuracy_test_pow2_double, small_3D_backward_out_of_place_complex_interleaved_to_complex_planar)
{
    try { small_3D_backward_out_of_place_complex_interleaved_to_complex_planar< double,  fftw_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}
...
{
    try { small_3D_in_place_real_to_hermitian_interleaved< float,  fftwf_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}

TEST_F(accuracy_test_pow2_double, _small_3D_in_place_real_to_hermitian_interleaved)
{
    try { small_3D_in_place_real_to_hermitian_interleaved< double,  fftw_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}
...
{
    try { small_3D_in_place_hermitian_interleaved_to_real< float,  fftwf_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}

TEST_F(accuracy_test_pow2_double, _small_3D_in_place_hermitian_interleaved_to_real)
{
    try { small_3D_in_place_hermitian_interleaved_to_real< double,  fftw_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}
...
{
    try { small_3D_out_of_place_real_to_hermitian_interleaved< float,  fftwf_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}

TEST_F(accuracy_test_pow2_double, _small_3D_out_of_place_real_to_hermitian_interleaved)
{
    try { small_3D_out_of_place_real_to_hermitian_interleaved< double,  fftw_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}
...
{
    try { small_3D_out_of_place_hermitian_interleaved_to_real< float,  fftwf_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}

TEST_F(accuracy_test_pow2_double, _small_3D_out_of_place_hermitian_interleaved_to_real)
{
    try { small_3D_out_of_place_hermitian_interleaved_to_real< double,  fftw_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}
...
{
    try { small_3D_out_of_place_real_to_hermitian_planar< float,  fftwf_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}

TEST_F(accuracy_test_pow2_double, _small_3D_out_of_place_real_to_hermitian_planar)
{
    try { small_3D_out_of_place_real_to_hermitian_planar< double,  fftw_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}
...
{
    try { small_3D_out_of_place_hermitian_planar_to_real< float,  fftwf_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}

TEST_F(accuracy_test_pow2_double, _small_3D_out_of_place_hermitian_planar_to_real)
{
    try { small_3D_out_of_place_hermitian_planar_to_real< double,  fftw_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}
...
{
    try { large_3D_forward_in_place_complex_planar_to_complex_planar< float,  fftwf_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}

TEST_F(accuracy_test_pow2_double, large_3D_forward_in_place_complex_planar_to_complex_planar)
{
    try { large_3D_forward_in_place_complex_planar_to_complex_planar< double,  fftw_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}
...
{
    try { large_3D_backward_in_place_complex_planar_to_complex_planar< float,  fftwf_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}

TEST_F(accuracy_test_pow2_double, large_3D_backward_in_place_complex_planar_to_complex_planar)
{
    try { large_3D_backward_in_place_complex_planar_to_complex_planar< double,  fftw_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}
...
{
    try { large_3D_forward_in_place_complex_interleaved_to_complex_interleaved< float,  fftwf_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}

TEST_F(accuracy_test_pow2_double, large_3D_forward_in_place_complex_interleaved_to_complex_interleaved)
{
    try { large_3D_forward_in_place_complex_interleaved_to_complex_interleaved< double,  fftw_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}
...
{
    try { large_3D_backward_in_place_complex_interleaved_to_complex_interleaved< float,  fftwf_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}

TEST_F(accuracy_test_pow2_double, large_3D_backward_in_place_complex_interleaved_to_complex_interleaved)
{
    try { large_3D_backward_in_place_complex_interleaved_to_complex_interleaved< double,  fftw_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}
...
{
    try { large_3D_forward_out_of_place_complex_planar_to_complex_planar< float,  fftwf_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}

TEST_F(accuracy_test_pow2_double, large_3D_forward_out_of_place_complex_planar_to_complex_planar)
{
    try { large_3D_forward_out_of_place_complex_planar_to_complex_planar< double,  fftw_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}
...
{
    try { large_3D_backward_out_of_place_complex_planar_to_complex_planar< float,  fftwf_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}

TEST_F(accuracy_test_pow2_double, large_3D_backward_out_of_place_complex_planar_to_complex_planar)
{
    try { large_3D_backward_out_of_place_complex_planar_to_complex_planar< double,  fftw_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}
...
{
    try { large_3D_forward_out_of_place_complex_interleaved_to_complex_interleaved< float,  fftwf_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}

TEST_F(accuracy_test_pow2_double, large_3D_forward_out_of_place_complex_interleaved_to_complex_interleaved)
{
    try { large_3D_forward_out_of_place_complex_interleaved_to_complex_interleaved< double,  fftw_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}
...
{
    try { large_3D_backward_out_of_place_complex_interleaved_to_complex_interleaved< float,  fftwf_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}

TEST_F(accuracy_test_pow2_double, large_3D_backward_out_of_place_complex_interleaved_to_complex_interleaved)
{
    try { large_3D_backward_out_of_place_complex_interleaved_to_complex_interleaved< double,  fftw_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}
...
{
    try { large_3D_forward_out_of_place_complex_planar_to_complex_interleaved< float,  fftwf_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}

TEST_F(accuracy_test_pow2_double, large_3D_forward_out_of_place_complex_planar_to_complex_interleaved)
{
    try { large_3D_forward_out_of_place_complex_planar_to_complex_interleaved< double,  fftw_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}
...
{
    try { large_3D_backward_out_of_place_complex_planar_to_complex_interleaved< float,  fftwf_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}

TEST_F(accuracy_test_pow2_double, large_3D_backward_out_of_place_complex_planar_to_complex_interleaved)
{
    try { large_3D_backward_out_of_place_complex_planar_to_complex_interleaved< double,  fftw_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}
...
{
    try { large_3D_forward_out_of_place_complex_interleaved_to_complex_planar< float,  fftwf_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}

TEST_F(accuracy_test_pow2_double, large_3D_forward_out_of_place_complex_interleaved_to_complex_planar)
{
    try { large_3D_forward_out_of_place_complex_interleaved_to_complex_planar< double,  fftw_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}
...
{
    try { large_3D_backward_out_of_place_complex_interleaved_to_complex_planar< float,  fftwf_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}

TEST_F(accuracy_test_pow2_double, large_3D_backward_out_of_place_complex_interleaved_to_complex_planar)
{
    try { large_3D_backward_out_of_place_complex_interleaved_to_complex_planar< double,  fftw_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}
...
{
    try { large_3D_in_place_real_to_hermitian_interleaved< float,  fftwf_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}

TEST_F(accuracy_test_pow2_double, large_3D_in_place_real_to_hermitian_interleaved)
{
    try { large_3D_in_place_real_to_hermitian_interleaved< double,  fftw_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}
...
{
    try { large_3D_in_place_hermitian_interleaved_to_real< float,  fftwf_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}

TEST_F(accuracy_test_pow2_double, large_3D_in_place_hermitian_interleaved_to_real)
{
    try { large_3D_in_place_hermitian_interleaved_to_real< double,  fftw_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}
...
{
    try { large_3D_out_of_place_real_to_hermitian_interleaved< float,  fftwf_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}

TEST_F(accuracy_test_pow2_double, large_3D_out_of_place_real_to_hermitian_interleaved)
{
    try { large_3D_out_of_place_real_to_hermitian_interleaved< double,  fftw_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}
...
{
    try { large_3D_out_of_place_hermitian_interleaved_to_real< float,  fftwf_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}

TEST_F(accuracy_test_pow2_double, large_3D_out_of_place_hermitian_interleaved_to_real)
{
    try { large_3D_out_of_place_hermitian_interleaved_to_real< double,  fftw_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}
...
{
    try { large_3D_out_of_place_real_to_hermitian_planar< float,  fftwf_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}

TEST_F(accuracy_test_pow2_double, large_3D_out_of_place_real_to_hermitian_planar)
{
    try { large_3D_out_of_place_real_to_hermitian_planar< double,  fftw_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}
...
{
    try { large_3D_out_of_place_hermitian_planar_to_real< float,  fftwf_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}

TEST_F(accuracy_test_pow2_double, large_3D_out_of_place_hermitian_planar_to_real)
{
    try { large_3D_out_of_place_hermitian_planar_to_real< double,  fftw_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}
...
{
    try { normal_1D_array_complex_to_complex< float,  fftwf_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}

TEST_F(accuracy_test_pow2_double, normal_1D_array_complex_to_complex)
{
    try { normal_1D_array_complex_to_complex< double,  fftw_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}
...
{
    try { normal_1D_array_complex_to_complex_with_odd_batch_size< float,  fftwf_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}

TEST_F(accuracy_test_pow2_double, normal_1D_array_complex_to_complex_with_odd_batch_size)
{
    try { normal_1D_array_complex_to_complex_with_odd_batch_size< double,  fftw_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}
...
{
    try { normal_1D_array_real_to_hermitian< float,  fftwf_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}

TEST_F(accuracy_test_pow2_double, normal_1D_array_real_to_hermitian)
{
    try { normal_1D_array_real_to_hermitian< double,  fftw_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}
...
{
    try { normal_1D_array_real_to_hermitian_with_odd_batch_size< float,  fftwf_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}

TEST_F(accuracy_test_pow2_double, normal_1D_array_real_to_hermitian_with_odd_batch_size)
{
    try { normal_1D_array_real_to_hermitian_with_odd_batch_size< double,  fftw_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}
...
{
    try { normal_1D_array_hermitian_to_real< float,  fftwf_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}

TEST_F(accuracy_test_pow2_double, normal_1D_array_hermitian_to_real)
{
    try { normal_1D_array_hermitian_to_real< double,  fftw_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}
...
{
    try { normal_1D_array_hermitian_to_real_with_odd_batch_size< float,  fftwf_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}

TEST_F(accuracy_test_pow2_double, normal_1D_array_hermitian_to_real_with_odd_batch_size)
{
    try { normal_1D_array_hermitian_to_real_with_odd_batch_size< double,  fftw_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}
...
{
    try { small_2D_array_real_to_hermitian< float,  fftwf_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}

TEST_F(accuracy_test_pow2_double, small_2D_array_real_to_hermitian)
{
    try { small_2D_array_real_to_hermitian< double,  fftw_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}
...
{
    try { small_2D_array_real_to_hermitian_with_odd_batch_size< float,  fftwf_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}

TEST_F(accuracy_test_pow2_double, small_2D_array_real_to_hermitian_with_odd_batch_size)
{
    try { small_2D_array_real_to_hermitian_with_odd_batch_size< double,  fftw_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}
...
{
    try { small_2D_array_hermitian_to_real< float,  fftwf_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}

TEST_F(accuracy_test_pow2_double, small_2D_array_hermitian_to_real)
{
    try { small_2D_array_hermitian_to_real< double,  fftw_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}
...
{
    try { small_2D_array_hermitian_to_real_with_odd_batch_size< float,  fftwf_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}

TEST_F(accuracy_test_pow2_double, small_2D_array_hermitian_to_real_with_odd_batch_size)
{
    try { small_2D_array_hermitian_to_real_with_odd_batch_size< double,  fftw_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}
...
{
    try { large_1D_array_complex_to_complex< float,  fftwf_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}

TEST_F(accuracy_test_pow2_double, large_1D_array_complex_to_complex)
{
    try { large_1D_array_complex_to_complex< double,  fftw_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}
...
{
    try { astoundingly_large_1D_complex_to_complex< float,  fftwf_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}

TEST_F(accuracy_test_pow2_double, DISABLED_astoundingly_large_1D_complex_to_complex)
{
    try { astoundingly_large_1D_complex_to_complex< double,  fftw_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}
...
{
    try { very_small_1D_non_unit_stride_complex_to_complex< float,  fftwf_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}

TEST_F(accuracy_test_pow2_double, very_small_1D_non_unit_stride_complex_to_complex)
{
    try { very_small_1D_non_unit_stride_complex_to_complex< double,  fftw_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}
...
{
    try {small_1D_non_unit_stride_real_to_hermitian< float,  fftwf_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}

TEST_F(accuracy_test_pow2_double, small_1D_non_unit_stride_real_to_hermitian)
{
    try { small_1D_non_unit_stride_real_to_hermitian< double,  fftw_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}
...
{
    try { small_1D_non_unit_stride_hermitian_to_real< float,  fftwf_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}

TEST_F(accuracy_test_pow2_double, small_1D_non_unit_stride_hermitian_to_real)
{
    try { small_1D_non_unit_stride_hermitian_to_real< double,  fftw_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}
...
{
    try {very_small_1D_non_unit_stride_real_to_hermitian< float,  fftwf_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}

TEST_F(accuracy_test_pow2_double, very_small_1D_non_unit_stride_real_to_hermitian)
{
    try { very_small_1D_non_unit_stride_real_to_hermitian< double,  fftw_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}
...
{
    try { very_small_1D_non_unit_stride_hermitian_to_real< float,  fftwf_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}

TEST_F(accuracy_test_pow2_double, very_small_1D_non_unit_stride_hermitian_to_real)
{
    try { very_small_1D_non_unit_stride_hermitian_to_real< double,  fftw_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}
...
{
    try {very_very_small_1D_non_unit_stride_real_to_hermitian< float,  fftwf_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}

TEST_F(accuracy_test_pow2_double, very_very_small_1D_non_unit_stride_real_to_hermitian)
{
    try { very_very_small_1D_non_unit_stride_real_to_hermitian< double,  fftw_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}
...
{
    try { very_very_small_1D_non_unit_stride_hermitian_to_real< float,  fftwf_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}

TEST_F(accuracy_test_pow2_double, very_very_small_1D_non_unit_stride_hermitian_to_real)
{
    try { very_very_small_1D_non_unit_stride_hermitian_to_real< double,  fftw_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}
...
{
    try { normal_1D_non_unit_stride_and_distance_complex_to_complex< float,  fftwf_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}

TEST_F(accuracy_test_pow2_double, normal_1D_non_unit_stride_and_distance_complex_to_complex)
{
    try { normal_1D_non_unit_stride_and_distance_complex_to_complex< double,  fftw_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}
...
{
    try { very_small_1D_non_unit_stride_and_distance_real_to_complex< float,  fftwf_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}

TEST_F(accuracy_test_pow2_double, very_small_1D_non_unit_stride_and_distance_real_to_complex)
{
    try { very_small_1D_non_unit_stride_and_distance_real_to_complex< double,  fftw_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}
...
{
    try { very_small_1D_out_of_place_different_input_output_non_unit_stride_and_distance_real_to_complex< float,  fftwf_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}
...
{
    try { very_small_1D_out_of_place_different_input_output_non_unit_stride_and_distance_real_to_complex< double,  fftw_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}
...
{
    try { very_small_1D_in_place_different_input_output_non_unit_stride_and_distance_real_to_complex< float,  fftwf_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}
...
{
    try { very_small_1D_in_place_different_input_output_non_unit_stride_and_distance_real_to_complex< double,  fftw_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}
...
void normal_1D_forward_user_defined_scale_complex_to_complex()
{
    ...
    data_pattern pattern = sawtooth;
    complex_to_complex<T, fftw_T>( pattern, transform_type, lengths, batch, input_strides, output_strides, input_distance, output_distance, in_array_type, out_array_type, placeness, 42.0f );
}

TEST_F(accuracy_test_pow2_single, normal_1D_forward_user_defined_scale_complex_to_complex)
{
    try { normal_1D_forward_user_defined_scale_complex_to_complex< float,  fftwf_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}

TEST_F(accuracy_test_pow2_double, normal_1D_forward_user_defined_scale_complex_to_complex)
{
    try { normal_1D_forward_user_defined_scale_complex_to_complex< double,  fftw_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}
...
void normal_1D_backward_user_defined_scale_complex_to_complex()
{
    ...
    data_pattern pattern = sawtooth;
    complex_to_complex<T, fftw_T>( pattern, transform_type, lengths, batch, input_strides, output_strides, input_distance, output_distance, in_array_type, out_array_type, placeness, 42.5f );
}

TEST_F(accuracy_test_pow2_single, normal_1D_backward_user_defined_scale_complex_to_complex)
{
    try { normal_1D_backward_user_defined_scale_complex_to_complex< float,  fftwf_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}

TEST_F(accuracy_test_pow2_double, normal_1D_backward_user_defined_scale_complex_to_complex)
{
    try { normal_1D_backward_user_defined_scale_complex_to_complex< double,  fftw_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}
...
{
    try { normal_1D_non_unit_stride_and_distance_real_to_hermitian< float,  fftwf_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}

TEST_F(accuracy_test_pow2_double, normal_1D_non_unit_stride_and_distance_real_to_hermitian)
{
    try { normal_1D_non_unit_stride_and_distance_real_to_hermitian< double,  fftw_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}
...
void normal_1D_user_defined_scale_real_to_hermitian()
{
    ...
    data_pattern pattern = impulse;
    real_to_complex<T, fftw_T>( pattern, lengths, batch, input_strides, output_strides, input_distance, output_distance, layout, placeness, 42.0f );
}

TEST_F(accuracy_test_pow2_single, normal_1D_user_defined_scale_real_to_hermitian)
{
    try { normal_1D_user_defined_scale_real_to_hermitian< float,  fftwf_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}

TEST_F(accuracy_test_pow2_double, normal_1D_user_defined_scale_real_to_hermitian)
{
    try { normal_1D_user_defined_scale_real_to_hermitian< double,  fftw_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}
...
{
    try { normal_1D_non_unit_stride_and_distance_hermitian_to_real< float,  fftwf_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}

TEST_F(accuracy_test_pow2_double, normal_1D_non_unit_stride_and_distance_hermitian_to_real)
{
    try { normal_1D_non_unit_stride_and_distance_hermitian_to_real< double,  fftw_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}
...
{
    try { small_2D_non_unit_stride_real_to_hermitian< float,  fftwf_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}

TEST_F(accuracy_test_pow2_double, small_2D_non_unit_stride_real_to_hermitian)
{
    try { small_2D_non_unit_stride_real_to_hermitian< double,  fftw_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}
...
{
    try { small_2D_non_unit_distance_real_to_hermitian< float,  fftwf_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}

TEST_F(accuracy_test_pow2_double, small_2D_non_unit_distance_real_to_hermitian)
{
    try { small_2D_non_unit_distance_real_to_hermitian< double,  fftw_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}
...
{
    try { small_2D_non_unit_stride_and_distance_real_to_hermitian< float,  fftwf_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}

TEST_F(accuracy_test_pow2_double, small_2D_non_unit_stride_and_distance_real_to_hermitian)
{
    try { small_2D_non_unit_stride_and_distance_real_to_hermitian< double,  fftw_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}
...
{
    try { small_2D_non_unit_stride_and_distance_hermitian_to_real< float,  fftwf_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}

TEST_F(accuracy_test_pow2_double, small_2D_non_unit_stride_and_distance_hermitian_to_real)
{
    try { small_2D_non_unit_stride_and_distance_hermitian_to_real< double,  fftw_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}
...
void normal_1D_user_defined_scale_hermitian_to_real()
{
    ...
    data_pattern pattern = sawtooth;
    complex_to_real<T, fftw_T>( pattern, lengths, batch, input_strides, output_strides, input_distance, output_distance, layout, placeness, 42.0f );
}

TEST_F(accuracy_test_pow2_single, normal_1D_user_defined_scale_hermitian_to_real)
{
    try { normal_1D_user_defined_scale_hermitian_to_real< float,  fftwf_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}

TEST_F(accuracy_test_pow2_double, normal_1D_user_defined_scale_hermitian_to_real)
{
    try { normal_1D_user_defined_scale_hermitian_to_real< double,  fftw_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}
...
void single_point_1D_forward_complex_to_complex()
{
    ...
    data_pattern pattern = impulse;
    complex_to_complex<T, fftw_T>( pattern, transform_type, lengths, batch, input_strides, output_strides, input_distance, output_distance, in_array_type, out_array_type, placeness, 0.42f );
}

TEST_F(accuracy_test_pow2_single, single_point_1D_forward_complex_to_complex)
{
    try { single_point_1D_forward_complex_to_complex< float,  fftwf_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}

TEST_F(accuracy_test_pow2_double, single_point_1D_forward_complex_to_complex)
{
    try { single_point_1D_forward_complex_to_complex< double,  fftw_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}
...
{
    try { single_point_1D_backward_complex_to_complex< float,  fftwf_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}

TEST_F(accuracy_test_pow2_double, single_point_1D_backward_complex_to_complex)
{
    try { single_point_1D_backward_complex_to_complex< double,  fftw_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}
...
{
    try { small_2D_non_unit_stride_complex_to_complex< float,  fftwf_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}

TEST_F(accuracy_test_pow2_double, small_2D_non_unit_stride_complex_to_complex)
{
    try { small_2D_non_unit_stride_complex_to_complex< double,  fftw_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}
...
{
    try { small_2D_non_unit_stride_and_distance_complex_to_complex< float,  fftwf_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}

TEST_F(accuracy_test_pow2_double, small_2D_non_unit_stride_and_distance_complex_to_complex)
{
    try { small_2D_non_unit_stride_and_distance_complex_to_complex< double,  fftw_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}
...
{
    try { normal_2D_forward_user_defined_scale_complex_to_complex< float,  fftwf_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}

TEST_F(accuracy_test_pow2_double, normal_2D_forward_user_defined_scale_complex_to_complex)
{
    try { normal_2D_forward_user_defined_scale_complex_to_complex< double,  fftw_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}
...
{
    try { normal_2D_backward_user_defined_scale_complex_to_complex< float,  fftwf_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}

TEST_F(accuracy_test_pow2_double, normal_2D_backward_user_defined_scale_complex_to_complex)
{
    try { normal_2D_backward_user_defined_scale_complex_to_complex< double,  fftw_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}
...
{
    try { rectangular_2D_array_complex_to_complex< float,  fftwf_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}

TEST_F(accuracy_test_pow2_double, rectangular_2D_array_complex_to_complex)
{
    try { rectangular_2D_array_complex_to_complex< double,  fftw_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}
...
{
    try { normal_2D_array_complex_to_complex_with_odd_batch_size< float,  fftwf_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}

TEST_F(accuracy_test_pow2_double, normal_2D_array_complex_to_complex_with_odd_batch_size)
{
    try { normal_2D_array_complex_to_complex_with_odd_batch_size< double,  fftw_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}
...
{
    try { large_2D_array_forward_complex_to_complex< float,  fftwf_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}

TEST_F(accuracy_test_pow2_double, large_2D_array_forward_complex_to_complex)
{
    try { large_2D_array_forward_complex_to_complex< double,  fftw_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}
...
{
    try { large_2D_array_backward_complex_to_complex< float,  fftwf_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}

TEST_F(accuracy_test_pow2_double, large_2D_array_backward_complex_to_complex)
{
    try { large_2D_array_backward_complex_to_complex< double,  fftw_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}
...
{
    try { single_point_2D_forward_complex_to_complex< float,  fftwf_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}

TEST_F(accuracy_test_pow2_double, single_point_2D_forward_complex_to_complex)
{
    try { single_point_2D_forward_complex_to_complex< double,  fftw_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}
...
{
    try { single_point_2D_backward_complex_to_complex< float,  fftwf_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}

TEST_F(accuracy_test_pow2_double, single_point_2D_backward_complex_to_complex)
{
    try { single_point_2D_backward_complex_to_complex< double,  fftw_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}
...
{
    try { single_point_3D_forward_complex_to_complex< float,  fftwf_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}

TEST_F(accuracy_test_pow2_double, single_point_3D_forward_complex_to_complex)
{
    try { single_point_3D_forward_complex_to_complex< double,  fftw_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}
...
{
    try { single_point_3D_backward_complex_to_complex< float,  fftwf_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}

TEST_F(accuracy_test_pow2_double, single_point_3D_backward_complex_to_complex)
{
    try { single_point_3D_backward_complex_to_complex< double,  fftw_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}
...
{
    try { small_3D_non_unit_stride_complex_to_complex< float,  fftwf_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}

TEST_F(accuracy_test_pow2_double, small_3D_non_unit_stride_complex_to_complex)
{
    try { small_3D_non_unit_stride_complex_to_complex< double,  fftw_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}
...
{
    try { small_3D_non_unit_stride_and_distance_complex_to_complex< float,  fftwf_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}

TEST_F(accuracy_test_pow2_double, small_3D_non_unit_stride_and_distance_complex_to_complex)
{
    try { small_3D_non_unit_stride_and_distance_complex_to_complex< double,  fftw_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}
...
void normal_1D_round_trip_complex_to_complex()
{
    ...
    lengths.push_back( normal2 );
    size_t batch = 1;
    rocfft_array_type array_type = rocfft_array_type_complex_interleaved;

    data_pattern pattern = sawtooth;
    complex_to_complex_round_trip<T, fftw_T>( pattern, lengths, batch, layout );
}

TEST_F(accuracy_test_pow2_single, normal_1D_round_trip_complex_to_complex)
{
    try { normal_1D_round_trip_complex_to_complex< float,  fftwf_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}

TEST_F(accuracy_test_pow2_double, normal_1D_round_trip_complex_to_complex)
{
    try { normal_1D_round_trip_complex_to_complex< double,  fftw_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}
...
void normal_2D_round_trip_complex_to_complex()
{
    ...
    lengths.push_back( normal2 );
    size_t batch = 1;
    rocfft_array_type array_type = rocfft_array_type_complex_planar;
...
{
    try { testcase_2D_round_trip_complex_to_complex< float,  fftwf_complex >(1024, 16); }
    catch( const std::exception& err ) { handle_exception(err);    }
}

TEST_F(accuracy_test_pow2_single, normal_2D_round_trip_complex_to_complex)
{
    try { normal_2D_round_trip_complex_to_complex< float,  fftwf_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}

TEST_F(accuracy_test_pow2_double, normal_2D_round_trip_complex_to_complex)
{
    try { normal_2D_round_trip_complex_to_complex< double,  fftw_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}
...
{
    try { small_3D_round_trip_complex_to_complex< float,  fftwf_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}

TEST_F(accuracy_test_pow2_double, small_3D_round_trip_complex_to_complex)
{
    try { small_3D_round_trip_complex_to_complex< double,  fftw_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}
...
void normal_1D_round_trip_real_to_complex()
{
    ...
    data_pattern pattern = impulse;
    real_to_complex_round_trip<T, fftw_T>( pattern, lengths, batch );
}

TEST_F(accuracy_test_pow2_single, normal_1D_round_trip_real_to_complex)
{
    try { normal_1D_round_trip_real_to_complex< float,  fftwf_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}

TEST_F(accuracy_test_pow2_double, normal_1D_round_trip_real_to_complex)
{
    try { normal_1D_round_trip_real_to_complex< double,  fftw_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}
...
{
    try { large_1D_round_trip_real_to_complex< float,  fftwf_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}

TEST_F(accuracy_test_pow2_double, large_1D_round_trip_real_to_complex)
{
    try { large_1D_round_trip_real_to_complex< double,  fftw_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}
...
{
    try { normal_2D_round_trip_real_to_complex< float,  fftwf_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}

TEST_F(accuracy_test_pow2_double, normal_2D_round_trip_real_to_complex)
{
    try { normal_2D_round_trip_real_to_complex< double,  fftw_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}
...
{
    try { small_3D_round_trip_real_to_complex< float,  fftwf_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}

TEST_F(accuracy_test_pow2_double, small_3D_round_trip_real_to_complex)
{
    try { small_3D_round_trip_real_to_complex< double,  fftw_complex >(); }
    catch( const std::exception& err ) { handle_exception(err);    }
}
