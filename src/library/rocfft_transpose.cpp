...
rocfft_transpose_status rocfft_transpose_outplace_complex_planar_to_complex_planar(const rocfft_transpose_plan plan, void *in_buffer_real, void *in_buffer_imag, void *out_buffer_real, void *out_buffer_imag)
{
   ...
   if(packed_data_in && packed_data_out)
   {
        ...
        else if(plan->precision == rocfft_transpose_precision_double)
        {
            /*if(input_row_size  % (block_size_16*micro_tile_size_4) == 0 && input_col_size % (block_size_16*micro_tile_size_4) == 0)
            {
                hipLaunchKernel(HIP_KERNEL_NAME(transpose_kernel_outplace_complex_planar_to_complex_planar<double,micro_tile_size_4,micro_tile_size_4,block_size_16,block_size_16>), dim3(input_col_size/micro_tile_size_4/block_size_16 * batch_size, input_row_size/micro_tile_size_4/block_size_16), dim3(block_size_16, block_size_16, 1), 0, 0, (double*)in_buffer_real, (double*)in_buffer_imag, (double*)out_buffer_real, (double*)out_buffer_imag, input_row_size, input_col_size, ld_in, ld_out, batch_size );
            }*/
            if(input_row_size % (block_size_16*micro_tile_size_2) == 0 && input_col_size % (block_size_16*micro_tile_size_2) == 0)
            {
                hipLaunchKernel(HIP_KERNEL_NAME(transpose_kernel_outplace_complex_planar_to_complex_planar<double,micro_tile_size_2,micro_tile_size_2,block_size_16,block_size_16>), dim3(input_col_size/micro_tile_size_2/block_size_16 * batch_size, input_row_size/micro_tile_size_2/block_size_16), dim3(block_size_16, block_size_16, 1), 0, 0, (double*)in_buffer_real, (double*)in_buffer_imag, (double*)out_buffer_real, (double*)out_buffer_imag, input_row_size, input_col_size, ld_in, ld_out, batch_size );
            }
            else if(input_row_size % (block_size_1*micro_tile_size_1) == 0 && input_col_size % (block_size_1*micro_tile_size_1) == 0)
            {
                // the kernel should be able to work on any size with no guarantee of performance
                hipLaunchKernel(HIP_KERNEL_NAME(transpose_kernel_outplace_complex_planar_to_complex_planar<double,micro_tile_size_1,micro_tile_size_1,block_size_1,block_size_1>), dim3(input_col_size/micro_tile_size_1/block_size_1 * batch_size, input_row_size/micro_tile_size_1/block_size_1), dim3(block_size_1, block_size_1, 1), 0, 0, (double*)in_buffer_real, (double*)in_buffer_imag, (double*)out_buffer_real, (double*)out_buffer_imag, input_row_size, input_col_size, ld_in, ld_out, batch_size );
            }
            else
                 return rocfft_transpose_status_not_implemented;
...
rocfft_transpose_status rocfft_transpose_outplace_complex_planar_to_complex_interleaved(const rocfft_transpose_plan plan, void *in_buffer_real, void *in_buffer_imag, void *out_buffer)
{
    const int block_size_16 = 16;//dim3(input_row_size/16/4, input_col_size/16/4, 1)
    const int block_size_8 = 8;
    const int block_size_1 = 1;
    ...
    if(packed_data_in && packed_data_out)
    {
        if(plan->precision == rocfft_transpose_precision_single)
        {
            if(input_row_size  % (block_size_16*micro_tile_size_4) == 0 && input_col_size % (block_size_16*micro_tile_size_4) == 0)
            {
                hipLaunchKernel(HIP_KERNEL_NAME(transpose_kernel_outplace_complex_planar_to_complex_interleaved<float,float2,micro_tile_size_4,micro_tile_size_4,block_size_16,block_size_16>), dim3(input_col_size/micro_tile_size_4/block_size_16 * batch_size, input_row_size/micro_tile_size_4/block_size_16), dim3(block_size_16, block_size_16, 1), 0, 0, (float*)in_buffer_real, (float*)in_buffer_imag, (float2*)out_buffer, input_row_size, input_col_size, ld_in, ld_out, batch_size );
            }
            else if(input_row_size % (block_size_16*micro_tile_size_2) == 0 && input_col_size % (block_size_16*micro_tile_size_2) == 0)
            {
                hipLaunchKernel(HIP_KERNEL_NAME(transpose_kernel_outplace_complex_planar_to_complex_interleaved<float,float2,micro_tile_size_2,micro_tile_size_2,block_size_16,block_size_16>), dim3(input_col_size/micro_tile_size_2/block_size_16 * batch_size, input_row_size/micro_tile_size_2/block_size_16), dim3(block_size_16, block_size_16, 1), 0, 0, (float*)in_buffer_real, (float*)in_buffer_imag, (float2*)out_buffer, input_row_size, input_col_size, ld_in, ld_out, batch_size );
            }
            else if(input_row_size % (block_size_1*micro_tile_size_1) == 0 && input_col_size % (block_size_1*micro_tile_size_1) == 0)
            {
                // the kernel should be able to work on any size with no guarantee of performance
                hipLaunchKernel(HIP_KERNEL_NAME(transpose_kernel_outplace_complex_planar_to_complex_interleaved<float,float2,micro_tile_size_1,micro_tile_size_1,block_size_1,block_size_1>), dim3(input_col_size/micro_tile_size_1/block_size_1 * batch_size, input_row_size/micro_tile_size_1/block_size_1), dim3(block_size_1, block_size_1, 1), 0, 0, (float*)in_buffer_real, (float*)in_buffer_imag, (float2*)out_buffer, input_row_size, input_col_size, ld_in, ld_out, batch_size );
            }
            else
                return rocfft_transpose_status_not_implemented;
        }
        else if(plan->precision == rocfft_transpose_precision_double)
        {
            if(input_row_size % (block_size_16*micro_tile_size_2) == 0 && input_col_size % (block_size_16*micro_tile_size_2) == 0)
            {
                hipLaunchKernel(HIP_KERNEL_NAME(transpose_kernel_outplace_complex_planar_to_complex_interleaved<double,double2,micro_tile_size_2,micro_tile_size_2,block_size_16,block_size_16>), dim3(input_col_size/micro_tile_size_2/block_size_16 * batch_size, input_row_size/micro_tile_size_2/block_size_16), dim3(block_size_16, block_size_16, 1), 0, 0, (double*)in_buffer_real, (double*)in_buffer_imag, (double2*)out_buffer, input_row_size, input_col_size, ld_in, ld_out, batch_size );
            }
            else if(input_row_size % (block_size_1*micro_tile_size_1) == 0 && input_col_size % (block_size_1*micro_tile_size_1) == 0)
            {
                // the kernel should be able to work on any size with no guarantee of performance
                hipLaunchKernel(HIP_KERNEL_NAME(transpose_kernel_outplace_complex_planar_to_complex_interleaved<double,double2,micro_tile_size_1,micro_tile_size_1,block_size_1,block_size_1>), dim3(input_col_size/micro_tile_size_1/block_size_1 * batch_size, input_row_size/micro_tile_size_1/block_size_1), dim3(block_size_1, block_size_1, 1), 0, 0, (double*)in_buffer_real, (double*)in_buffer_imag, (double2*)out_buffer, input_row_size, input_col_size, ld_in, ld_out, batch_size );
            }
            else
                return rocfft_transpose_status_not_implemented;
...
rocfft_transpose_status rocfft_transpose_outplace_complex_interleaved_to_complex_planar(const rocfft_transpose_plan plan, void *in_buffer, void *out_buffer_real, void *out_buffer_imag)
{
    const int block_size_16 = 16;//dim3(input_row_size/16/4, input_col_size/16/4, 1)
    const int block_size_8 = 8;
    const int block_size_1 = 1;
    ...
    if(packed_data_in && packed_data_out)
    {
        if(plan->precision == rocfft_transpose_precision_single)
        {
            if(input_row_size  % (block_size_16*micro_tile_size_4) == 0 && input_col_size % (block_size_16*micro_tile_size_4) == 0)
            {
                hipLaunchKernel(HIP_KERNEL_NAME(transpose_kernel_outplace_complex_interleaved_to_complex_planar<float2,float,micro_tile_size_4,micro_tile_size_4,block_size_16,block_size_16>), dim3(input_col_size/micro_tile_size_4/block_size_16 * batch_size, input_row_size/micro_tile_size_4/block_size_16), dim3(block_size_16, block_size_16, 1), 0, 0, (float2*)in_buffer, (float*)out_buffer_real, (float*)out_buffer_imag, input_row_size, input_col_size, ld_in, ld_out, batch_size );
            }
            else if(input_row_size % (block_size_16*micro_tile_size_2) == 0 && input_col_size % (block_size_16*micro_tile_size_2) == 0)
            {
                hipLaunchKernel(HIP_KERNEL_NAME(transpose_kernel_outplace_complex_interleaved_to_complex_planar<float2,float,micro_tile_size_2,micro_tile_size_2,block_size_16,block_size_16>), dim3(input_col_size/micro_tile_size_2/block_size_16 * batch_size, input_row_size/micro_tile_size_2/block_size_16), dim3(block_size_16, block_size_16, 1), 0, 0, (float2*)in_buffer, (float*)out_buffer_real, (float*)out_buffer_imag, input_row_size, input_col_size, ld_in, ld_out, batch_size );
            }
            else if(input_row_size % (block_size_1*micro_tile_size_1) == 0 && input_col_size % (block_size_1*micro_tile_size_1) == 0)
            {
                // the kernel should be able to work on any size with no guarantee of performance
                hipLaunchKernel(HIP_KERNEL_NAME(transpose_kernel_outplace_complex_interleaved_to_complex_planar<float2,float,micro_tile_size_1,micro_tile_size_1,block_size_1,block_size_1>), dim3(input_col_size/micro_tile_size_1/block_size_1 * batch_size, input_row_size/micro_tile_size_1/block_size_1), dim3(block_size_1, block_size_1, 1), 0, 0, (float2*)in_buffer, (float*)out_buffer_real, (float*)out_buffer_imag, input_row_size, input_col_size, ld_in, ld_out, batch_size );
            }
            else
                return rocfft_transpose_status_not_implemented;
        }
        else if(plan->precision == rocfft_transpose_precision_double)
        {
            if(input_row_size % (block_size_16*micro_tile_size_2) == 0 && input_col_size % (block_size_16*micro_tile_size_2) == 0)
            {
                hipLaunchKernel(HIP_KERNEL_NAME(transpose_kernel_outplace_complex_interleaved_to_complex_planar<double2,double,micro_tile_size_2,micro_tile_size_2,block_size_16,block_size_16>), dim3(input_col_size/micro_tile_size_2/block_size_16 * batch_size, input_row_size/micro_tile_size_2/block_size_16), dim3(block_size_16, block_size_16, 1), 0, 0, (double2*)in_buffer, (double*)out_buffer_real, (double*)out_buffer_imag, input_row_size, input_col_size, ld_in, ld_out, batch_size );
            }
            else if(input_row_size % (block_size_1*micro_tile_size_1) == 0 && input_col_size % (block_size_1*micro_tile_size_1) == 0)
            {
                // the kernel should be able to work on any size with no guarantee of performance
                hipLaunchKernel(HIP_KERNEL_NAME(transpose_kernel_outplace_complex_interleaved_to_complex_planar<double2,double,micro_tile_size_1,micro_tile_size_1,block_size_1,block_size_1>), dim3(input_col_size/micro_tile_size_1/block_size_1 * batch_size, input_row_size/micro_tile_size_1/block_size_1), dim3(block_size_1, block_size_1, 1), 0, 0, (double2*)in_buffer, (double*)out_buffer_real, (double*)out_buffer_imag, input_row_size, input_col_size, ld_in, ld_out, batch_size );
            }
            else
                return rocfft_transpose_status_not_implemented;
