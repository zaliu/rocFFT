...
fft_128_32768(uint b, uint me, __local float2 *lds, const int dir)
{
	...
	if(dir == -1)
	{
		TWIDDLE_3STEP_MUL_FWD(TW3step_32768, ((2*me + 0)%32 +  0)*b, X0)
		TWIDDLE_3STEP_MUL_FWD(TW3step_32768, ((2*me + 0)%32 + 32)*b, X1)
		TWIDDLE_3STEP_MUL_FWD(TW3step_32768, ((2*me + 0)%32 + 64)*b, X2)
		TWIDDLE_3STEP_MUL_FWD(TW3step_32768, ((2*me + 0)%32 + 96)*b, X3)	

		TWIDDLE_3STEP_MUL_FWD(TW3step_32768, ((2*me + 1)%32 +  0)*b, X4)
		TWIDDLE_3STEP_MUL_FWD(TW3step_32768, ((2*me + 1)%32 + 32)*b, X5)
		TWIDDLE_3STEP_MUL_FWD(TW3step_32768, ((2*me + 1)%32 + 64)*b, X6)
		TWIDDLE_3STEP_MUL_FWD(TW3step_32768, ((2*me + 1)%32 + 96)*b, X7)
	}
	else
	{
		TWIDDLE_3STEP_MUL_INV(TW3step_32768, ((2*me + 0)%32 +  0)*b, X0)
		TWIDDLE_3STEP_MUL_INV(TW3step_32768, ((2*me + 0)%32 + 32)*b, X1)
		TWIDDLE_3STEP_MUL_INV(TW3step_32768, ((2*me + 0)%32 + 64)*b, X2)
		TWIDDLE_3STEP_MUL_INV(TW3step_32768, ((2*me + 0)%32 + 96)*b, X3)	

		TWIDDLE_3STEP_MUL_INV(TW3step_32768, ((2*me + 1)%32 +  0)*b, X4)
		TWIDDLE_3STEP_MUL_INV(TW3step_32768, ((2*me + 1)%32 + 32)*b, X5)
		TWIDDLE_3STEP_MUL_INV(TW3step_32768, ((2*me + 1)%32 + 64)*b, X6)
		TWIDDLE_3STEP_MUL_INV(TW3step_32768, ((2*me + 1)%32 + 96)*b, X7)
	}
