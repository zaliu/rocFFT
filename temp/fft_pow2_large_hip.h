...
__device__ float2
TW3step2(float2 *twiddles, size_t u)
{
	size_t j = u & 255;
...
__device__ float2
TW3step3(float2 *twiddles, size_t u)
{
	size_t j = u & 255;
	float2 result = twiddles[j];
	u >>= 8;
...
__device__ void
fft_64_8192(float2 *twiddles_64, float2 *twiddles_8192, uint b, uint me, float2 *lds, const int dir)
{
	float2 X0, X1, X2, X3;
	...
	if(dir == -1)
	{
		TWIDDLE_3STEP_MUL_FWD(TW3step2, twiddles_8192, (me +  0)*b, X0)	
		TWIDDLE_3STEP_MUL_FWD(TW3step2, twiddles_8192, (me + 16)*b, X1)	
		TWIDDLE_3STEP_MUL_FWD(TW3step2, twiddles_8192, (me + 32)*b, X2)	
		TWIDDLE_3STEP_MUL_FWD(TW3step2, twiddles_8192, (me + 48)*b, X3)			
	}
	else
	{
		TWIDDLE_3STEP_MUL_INV(TW3step2, twiddles_8192, (me +  0)*b, X0)	
		TWIDDLE_3STEP_MUL_INV(TW3step2, twiddles_8192, (me + 16)*b, X1)	
		TWIDDLE_3STEP_MUL_INV(TW3step2, twiddles_8192, (me + 32)*b, X2)	
		TWIDDLE_3STEP_MUL_INV(TW3step2, twiddles_8192, (me + 48)*b, X3)				
	}
...
__device__ void
tfft_128(float2 *twiddles_128, uint me, float2 *lds, const int dir)
{
...
__global__
void fft_8192_1(hipLaunchParm lp, float2 *twiddles_64, float2 *twiddles_8192, float2 * gbIn, float2 * gbOut, const uint count, const int dir)
{
	...
	for(uint t=0; t<2; t++)
	{
		...
		fft_64_8192(twiddles_64, twiddles_8192, b, me%16, lds + t*512 + (me/16)*64, dir);
...
__global__
void fft_8192_2(hipLaunchParm lp, float2 *twiddles_128, float2 * gbIn, float2 * gbOut, const uint count, const int dir)
{
	uint me = hipThreadIdx_x;
	uint batch = hipBlockIdx_x;
	...
	tfft_128(twiddles_128, me%16, lds + (me/16)*128, dir);
...
__device__ void
fft_64_16384(float2 *twiddles_64, float2 *twiddles_16384, uint b, uint me, float2 *lds, const int dir)
{
	float2 X0, X1, X2, X3;
	...
	if(dir == -1)
	{
		TWIDDLE_3STEP_MUL_FWD(TW3step2, twiddles_16384, (me +  0)*b, X0)	
		TWIDDLE_3STEP_MUL_FWD(TW3step2, twiddles_16384, (me + 16)*b, X1)	
		TWIDDLE_3STEP_MUL_FWD(TW3step2, twiddles_16384, (me + 32)*b, X2)	
		TWIDDLE_3STEP_MUL_FWD(TW3step2, twiddles_16384, (me + 48)*b, X3)			
	}
	else
	{
		TWIDDLE_3STEP_MUL_INV(TW3step2, twiddles_16384, (me +  0)*b, X0)	
		TWIDDLE_3STEP_MUL_INV(TW3step2, twiddles_16384, (me + 16)*b, X1)	
		TWIDDLE_3STEP_MUL_INV(TW3step2, twiddles_16384, (me + 32)*b, X2)	
		TWIDDLE_3STEP_MUL_INV(TW3step2, twiddles_16384, (me + 48)*b, X3)				
	}
...
__device__ void
tfft_256(float2 *twiddles_256, uint me, float2 *lds, const int dir)
{
	float2 X0, X1, X2, X3;
...
__global__
void fft_16384_1(hipLaunchParm lp, float2 *twiddles_64, float2 *twiddles_16384, float2 * gbIn, float2 * gbOut, const uint count, const int dir)
{
	uint me = hipThreadIdx_x;
	uint batch = hipBlockIdx_x;
	...
	for(uint t=0; t<2; t++)
	{
		...
		fft_64_16384(twiddles_64, twiddles_16384, b, me%16, lds + t*512 + (me/16)*64, dir);
...
__global__
void fft_16384_2(hipLaunchParm lp, float2 *twiddles_256, float2 * gbIn, float2 * gbOut, const uint count, const int dir)
{
	uint me = hipThreadIdx_x;
	uint batch = hipBlockIdx_x;
	...
	for(uint t=0; t<2; t++)
	{
		tfft_256(twiddles_256, me%64, lds + t*1024 + (me/64)*256, dir);
...
__device__ void
fft_128_32768(float2 *twiddles_128, float2 *twiddles_32768, uint b, uint me, float2 *lds, const int dir)
{
	float2 X0, X1, X2, X3, X4, X5, X6, X7;
	...
	if(dir == -1)
	{
		TWIDDLE_3STEP_MUL_FWD(TW3step2, twiddles_32768, ((2*me + 0) +  0)*b, X0)
		TWIDDLE_3STEP_MUL_FWD(TW3step2, twiddles_32768, ((2*me + 0) + 32)*b, X1)
		TWIDDLE_3STEP_MUL_FWD(TW3step2, twiddles_32768, ((2*me + 0) + 64)*b, X2)
		TWIDDLE_3STEP_MUL_FWD(TW3step2, twiddles_32768, ((2*me + 0) + 96)*b, X3)	

		TWIDDLE_3STEP_MUL_FWD(TW3step2, twiddles_32768, ((2*me + 1) +  0)*b, X4)
		TWIDDLE_3STEP_MUL_FWD(TW3step2, twiddles_32768, ((2*me + 1) + 32)*b, X5)
		TWIDDLE_3STEP_MUL_FWD(TW3step2, twiddles_32768, ((2*me + 1) + 64)*b, X6)
		TWIDDLE_3STEP_MUL_FWD(TW3step2, twiddles_32768, ((2*me + 1) + 96)*b, X7)
	}
	else
	{
		TWIDDLE_3STEP_MUL_INV(TW3step2, twiddles_32768, ((2*me + 0) +  0)*b, X0)
		TWIDDLE_3STEP_MUL_INV(TW3step2, twiddles_32768, ((2*me + 0) + 32)*b, X1)
		TWIDDLE_3STEP_MUL_INV(TW3step2, twiddles_32768, ((2*me + 0) + 64)*b, X2)
		TWIDDLE_3STEP_MUL_INV(TW3step2, twiddles_32768, ((2*me + 0) + 96)*b, X3)	

		TWIDDLE_3STEP_MUL_INV(TW3step2, twiddles_32768, ((2*me + 1) +  0)*b, X4)
		TWIDDLE_3STEP_MUL_INV(TW3step2, twiddles_32768, ((2*me + 1) + 32)*b, X5)
		TWIDDLE_3STEP_MUL_INV(TW3step2, twiddles_32768, ((2*me + 1) + 64)*b, X6)
		TWIDDLE_3STEP_MUL_INV(TW3step2, twiddles_32768, ((2*me + 1) + 96)*b, X7)
	}
...
__global__
void fft_32768_1(hipLaunchParm lp, float2 *twiddles_128, float2 *twiddles_32768, float2 * gbIn, float2 * gbOut, const uint count, const int dir)
{
	uint me = hipThreadIdx_x;
	uint batch = hipBlockIdx_x;
	...
	fft_128_32768(twiddles_128, twiddles_32768, b, me%16, lds + (me/16)*128, dir);
...
__global__
void fft_32768_2(hipLaunchParm lp, float2 *twiddles_256, float2 * gbIn, float2 * gbOut, const uint count, const int dir)
{
	uint me = hipThreadIdx_x;
	uint batch = hipBlockIdx_x;
...
__device__ void
fft_256_65536(float2 *twiddles_256, float2 *twiddles_65536, uint b, uint me, float2 *lds, const int dir)
{
	float2 X0, X1, X2, X3;
	...
	if(dir == -1)
	{
		TWIDDLE_3STEP_MUL_FWD(TW3step2, twiddles_65536, (me +   0)*b, X0)	
		TWIDDLE_3STEP_MUL_FWD(TW3step2, twiddles_65536, (me +  64)*b, X1)	
		TWIDDLE_3STEP_MUL_FWD(TW3step2, twiddles_65536, (me + 128)*b, X2)	
		TWIDDLE_3STEP_MUL_FWD(TW3step2, twiddles_65536, (me + 192)*b, X3)			
	}
	else
	{
		TWIDDLE_3STEP_MUL_INV(TW3step2, twiddles_65536, (me +   0)*b, X0)	
		TWIDDLE_3STEP_MUL_INV(TW3step2, twiddles_65536, (me +  64)*b, X1)	
		TWIDDLE_3STEP_MUL_INV(TW3step2, twiddles_65536, (me + 128)*b, X2)	
		TWIDDLE_3STEP_MUL_INV(TW3step2, twiddles_65536, (me + 192)*b, X3)				
	}
...
__global__
void fft_65536_1(hipLaunchParm lp, float2 *twiddles_256, float2 *twiddles_65536, float2 * gbIn, float2 * gbOut, const uint count, const int dir)
{
	uint me = hipThreadIdx_x;
	uint batch = hipBlockIdx_x;
	...
	for(uint t=0; t<2; t++)
	{
		...
		fft_256_65536(twiddles_256, twiddles_65536, b, me%64, lds + t*1024 + (me/64)*256, dir);
...
__global__
void fft_65536_2(hipLaunchParm lp, float2 *twiddles_256, float2 * gbIn, float2 * gbOut, const uint count, const int dir)
{
	uint me = hipThreadIdx_x;
	uint batch = hipBlockIdx_x;
...
__device__ void
fft_64_131072(float2 *twiddles_64, float2 *twiddles_131072, uint b, uint me, float2 *lds, const int dir)
{
	float2 X0, X1, X2, X3;
	...
	if(dir == -1)
	{
		TWIDDLE_3STEP_MUL_FWD(TW3step3, twiddles_131072, (me +  0)*b, X0)	
		TWIDDLE_3STEP_MUL_FWD(TW3step3, twiddles_131072, (me + 16)*b, X1)	
		TWIDDLE_3STEP_MUL_FWD(TW3step3, twiddles_131072, (me + 32)*b, X2)	
		TWIDDLE_3STEP_MUL_FWD(TW3step3, twiddles_131072, (me + 48)*b, X3)			
	}
	else
	{
		TWIDDLE_3STEP_MUL_INV(TW3step3, twiddles_131072, (me +  0)*b, X0)	
		TWIDDLE_3STEP_MUL_INV(TW3step3, twiddles_131072, (me + 16)*b, X1)	
		TWIDDLE_3STEP_MUL_INV(TW3step3, twiddles_131072, (me + 32)*b, X2)	
		TWIDDLE_3STEP_MUL_INV(TW3step3, twiddles_131072, (me + 48)*b, X3)				
	}
...
__device__ void
tfft_2048(float2 *twiddles_2048, uint me, float *lds, float2 *lwb, const int dir)
{
...
__global__
void fft_131072_1(hipLaunchParm lp, float2 *twiddles_64, float2 *twiddles_131072, float2 * gbIn, float2 * gbOut, const uint count, const int dir)
{
	uint me = hipThreadIdx_x;
	uint batch = hipBlockIdx_x;
	...
	for(uint t=0; t<2; t++)
	{
		...
		fft_64_131072(twiddles_64, twiddles_131072, b, me%16, lds + t*512 + (me/16)*64, dir);
...
__global__
void fft_131072_2(hipLaunchParm lp, float2 *twiddles_2048, float2 * gb, const uint count, const int dir)
{
	uint me = hipThreadIdx_x;
	uint batch = hipBlockIdx_x;
	...
	tfft_2048(twiddles_2048, me, lds, lwb, dir);
...
__device__ void
fft_64_262144(float2 *twiddles_64, float2 *twiddles_262144, uint b, uint me, float2 *lds, const int dir)
{
	float2 X0, X1, X2, X3;
	...
	if(dir == -1)
	{
		TWIDDLE_3STEP_MUL_FWD(TW3step3, twiddles_262144, (me +  0)*b, X0)	
		TWIDDLE_3STEP_MUL_FWD(TW3step3, twiddles_262144, (me + 16)*b, X1)	
		TWIDDLE_3STEP_MUL_FWD(TW3step3, twiddles_262144, (me + 32)*b, X2)	
		TWIDDLE_3STEP_MUL_FWD(TW3step3, twiddles_262144, (me + 48)*b, X3)			
	}
	else
	{
		TWIDDLE_3STEP_MUL_INV(TW3step3, twiddles_262144, (me +  0)*b, X0)	
		TWIDDLE_3STEP_MUL_INV(TW3step3, twiddles_262144, (me + 16)*b, X1)	
		TWIDDLE_3STEP_MUL_INV(TW3step3, twiddles_262144, (me + 32)*b, X2)	
		TWIDDLE_3STEP_MUL_INV(TW3step3, twiddles_262144, (me + 48)*b, X3)				
	}
...
__device__ void
tfft_4096(float2 *twiddles_4096, uint me, float *lds, float2 *lwb, const int dir)
{
	float2 X0, X1, X2, X3, X4, X5, X6, X7;
...
__global__
void fft_262144_1(hipLaunchParm lp, float2 *twiddles_64, float2 *twiddles_262144, float2 * gbIn, float2 * gbOut, const uint count, const int dir)
{
	uint me = hipThreadIdx_x;
	uint batch = hipBlockIdx_x;
	...
	for(uint t=0; t<2; t++)
	{
		...
		fft_64_262144(twiddles_64, twiddles_262144, b, me%16, lds + t*512 + (me/16)*64, dir);
...
__global__
void fft_262144_2(hipLaunchParm lp, float2 *twiddles_4096, float2 * gb, const uint count, const int dir)
{
	uint me = hipThreadIdx_x;
	uint batch = hipBlockIdx_x;
	...
	tfft_4096(twiddles_4096, me, lds, lwb, dir);
...
__device__ void
tfft_1024(float2 *twiddles_1024, uint me, float *lds, float2 *lwbIn, float2 *lwbOut, const int dir)
{
	float2 X0, X1, X2, X3, X4, X5, X6, X7;
...
__device__ void
tfft_512(float2 *twiddles_512, uint me, float *lds, float2 *lwb, const int dir)
{
	float2 X0, X1, X2, X3, X4, X5, X6, X7;
...
__global__
void fft_524288_1(hipLaunchParm lp, float2 *twiddles_1024, float2 * gbIn, float2 * gbOut, const uint count, const int dir)
{
	uint me = hipThreadIdx_x;
	uint batch = hipBlockIdx_x;
	...
	tfft_1024(twiddles_1024, me, lds, lwbIn, lwbOut, dir);
}

__global__
void
transpose_524288_2( hipLaunchParm lp, float2 *twiddles_524288, float2* pmComplexIn, float2* pmComplexOut, const uint count, const int dir )
{
   const Tile localIndex = { (size_t)hipThreadIdx_x, (size_t)hipThreadIdx_y }; 
   const Tile localExtent = { (size_t)hipBlockDim_x, (size_t)hipBlockDim_y }; 
   const Tile groupIndex = { (size_t)hipBlockIdx_x, (size_t)hipBlockIdx_y };
   ...
   rowSizeinUnits = 1024;
      ...
      for( uint t=0; t < wgUnroll; t++ )
      {
		 ...
		 if(dir == -1)
		 {
			TWIDDLE_3STEP_MUL_FWD(TW3step3, twiddles_524288, (groupIndex.x * wgTileExtent.x + xInd) * (currDimIndex * wgTileExtent.y * wgUnroll + yInd), tmp)
		 }
		 else
		 {
			TWIDDLE_3STEP_MUL_INV(TW3step3, twiddles_524288, (groupIndex.x * wgTileExtent.x + xInd) * (currDimIndex * wgTileExtent.y * wgUnroll + yInd), tmp)
		 }
...
__global__
void fft_524288_2(hipLaunchParm lp, float2 *twiddles_512, float2 * gb, const uint count, const int dir)
{
	uint me = hipThreadIdx_x;
	uint batch = hipBlockIdx_x;
	...
	tfft_512(twiddles_512, me, lds, lwb, dir);
...
__global__
void fft_1048576_1(hipLaunchParm lp, float2 *twiddles_1024, float2 * gbIn, float2 * gbOut, const uint count, const int dir)
{
	uint me = hipThreadIdx_x;
	uint batch = hipBlockIdx_x;
...
__global__
void
transpose_1048576_2( hipLaunchParm lp, float2 *twiddles_1048576, float2* pmComplexIn, float2* pmComplexOut, const uint count, const int dir )
{
   const Tile localIndex = { (size_t)hipThreadIdx_x, (size_t)hipThreadIdx_y }; 
   const Tile localExtent = { (size_t)hipBlockDim_x, (size_t)hipBlockDim_y }; 
   const Tile groupIndex = { (size_t)hipBlockIdx_x, (size_t)hipBlockIdx_y };
   ...
   rowSizeinUnits = 1024;
      ...
      for( uint t=0; t < wgUnroll; t++ )
      {
		 ...
		 if(dir == -1)
		 {
			TWIDDLE_3STEP_MUL_FWD(TW3step3, twiddles_1048576, (groupIndex.x * wgTileExtent.x + xInd) * (currDimIndex * wgTileExtent.y * wgUnroll + yInd), tmp)		 
		 }
		 else
		 {
			TWIDDLE_3STEP_MUL_INV(TW3step3, twiddles_1048576, (groupIndex.x * wgTileExtent.x + xInd) * (currDimIndex * wgTileExtent.y * wgUnroll + yInd), tmp)		 
		 }
...
__global__
void fft_1048576_2(hipLaunchParm lp, float2 *twiddles_1024, float2 * gb, const uint count, const int dir)
{
	uint me = hipThreadIdx_x;
	uint batch = hipBlockIdx_x;
	...
	tfft_1024(twiddles_1024, me, lds, lwb, lwb, dir);
